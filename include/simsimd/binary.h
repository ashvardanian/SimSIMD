...
/** @copydoc simsimd_jaccard_b128_state_neon_t */
SIMSIMD_INTERNAL void simsimd_jaccard_b128_update_neon(simsimd_jaccard_b128_state_neon_t *state, uint8x16_t a, uint8x16_t b);
/** @copydoc simsimd_jaccard_b128_state_neon_t */
SIMSIMD_INTERNAL void simsimd_jaccard_b128_finalize_neon(simsimd_jaccard_b128_state_neon_t const *state_a, simsimd_jaccard_b128_state_neon_t const *state_b, simsimd_jaccard_b128_state_neon_t const *state_c, simsimd_jaccard_b128_state_neon_t const *state_d, simsimd_f32_t query_popcount, simsimd_f32_t target_popcount_a, simsimd_f32_t target_popcount_b, simsimd_f32_t target_popcount_c, simsimd_f32_t target_popcount_d, simsimd_f32_t *results);
...
/** @copydoc simsimd_jaccard_b256_state_haswell_t */
SIMSIMD_INTERNAL void simsimd_jaccard_b256_update_haswell(simsimd_jaccard_b256_state_haswell_t *state, __m256i a, __m256i b);
/** @copydoc simsimd_jaccard_b256_state_haswell_t */
SIMSIMD_INTERNAL void simsimd_jaccard_b256_finalize_haswell(simsimd_jaccard_b256_state_haswell_t const *state_a, simsimd_jaccard_b256_state_haswell_t const *state_b, simsimd_jaccard_b256_state_haswell_t const *state_c, simsimd_jaccard_b256_state_haswell_t const *state_d, simsimd_f32_t query_popcount, simsimd_f32_t target_popcount_a, simsimd_f32_t target_popcount_b, simsimd_f32_t target_popcount_c, simsimd_f32_t target_popcount_d, simsimd_f32_t *results);
...
/** @copydoc simsimd_jaccard_b512_state_ice_t */
SIMSIMD_INTERNAL void simsimd_jaccard_b512_finalize_ice(simsimd_jaccard_b512_state_ice_t const *state_a, simsimd_jaccard_b512_state_ice_t const *state_b, simsimd_jaccard_b512_state_ice_t const *state_c, simsimd_jaccard_b512_state_ice_t const *state_d, simsimd_f32_t query_popcount, simsimd_f32_t target_popcount_a, simsimd_f32_t target_popcount_b, simsimd_f32_t target_popcount_c, simsimd_f32_t target_popcount_d, simsimd_f32_t *results);
...
typedef struct simsimd_jaccard_b128_state_neon_t {
    uint32x4_t intersection_count; ///< Vector accumulator - defers horizontal sum to finalize
...
typedef struct simsimd_jaccard_b256_state_haswell_t {
    simsimd_size_t intersection_count; ///< Single accumulator - OoO handles ILP across calls
...
SIMSIMD_INTERNAL void simsimd_jaccard_b256_update_haswell(simsimd_jaccard_b256_state_haswell_t *state, __m256i a,
                                                          __m256i b) {
    ...
    __m128i intersection_lo = _mm256_castsi256_si128(intersection);      // FREE (register view)
    __m128i intersection_hi = _mm256_extracti128_si256(intersection, 1); // p5, 3cy

    // Step 3: Extract individual 64-bit words for scalar popcount
    simsimd_u64_t word_a = (simsimd_u64_t)_mm_cvtsi128_si64(intersection_lo);
    simsimd_u64_t word_b = (simsimd_u64_t)_mm_extract_epi64(intersection_lo, 1);
    simsimd_u64_t word_c = (simsimd_u64_t)_mm_cvtsi128_si64(intersection_hi);
    simsimd_u64_t word_d = (simsimd_u64_t)_mm_extract_epi64(intersection_hi, 1);

    // Step 4: Popcount each word (p1 bottleneck: 4 ops @ 1cy throughput = 4cy)
    simsimd_size_t partial_a = (simsimd_size_t)_mm_popcnt_u64(word_a);
    simsimd_size_t partial_b = (simsimd_size_t)_mm_popcnt_u64(word_b);
    simsimd_size_t partial_c = (simsimd_size_t)_mm_popcnt_u64(word_c);
    simsimd_size_t partial_d = (simsimd_size_t)_mm_popcnt_u64(word_d);
