 ...
 */
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_b8_t) == 1, mathkong_b8_t_must_be_1_byte);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_i4x2_t) == 1, mathkong_i4x2_t_must_be_1_byte);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_i8_t) == 1, mathkong_i8_t_must_be_1_byte);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_u8_t) == 1, mathkong_u8_t_must_be_1_byte);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_i16_t) == 2, mathkong_i16_t_must_be_2_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_u16_t) == 2, mathkong_u16_t_must_be_2_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_i32_t) == 4, mathkong_i32_t_must_be_4_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_u32_t) == 4, mathkong_u32_t_must_be_4_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_i64_t) == 8, mathkong_i64_t_must_be_8_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_u64_t) == 8, mathkong_u64_t_must_be_8_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_f32_t) == 4, mathkong_f32_t_must_be_4_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_f64_t) == 8, mathkong_f64_t_must_be_8_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_f16_t) == 2, mathkong_f16_t_must_be_2_bytes);
_SIMSIMD_STATIC_ASSERT(sizeof(mathkong_bf16_t) == 2, mathkong_bf16_t_must_be_2_bytes);
 ...
 */
SIMSIMD_INTERNAL mathkong_f32_t mathkong_f32_rsqrt(mathkong_f32_t number) {
 ...
 */
SIMSIMD_INTERNAL mathkong_f32_t mathkong_f32_sqrt(mathkong_f32_t number) { return number * mathkong_f32_rsqrt(number); }
 ...
 */
SIMSIMD_INTERNAL mathkong_f32_t mathkong_f32_log(mathkong_f32_t number) {
 ...
 */
SIMSIMD_INTERNAL mathkong_f32_t mathkong_f16_to_f32_implementation(mathkong_f16_t const *x_ptr) {
    unsigned short x;
 ...
 *  https://github.com/OpenCyphal/libcanard/blob/636795f4bc395f56af8d2c61d3757b5e762bb9e5/canard.c#L811-L834
 */
SIMSIMD_INTERNAL void mathkong_f32_to_f16_implementation(mathkong_f32_t x, mathkong_f16_t *result_ptr) {
    mathkong_fui32_t conv;
    conv.f = x;
 ...
 */
SIMSIMD_INTERNAL mathkong_f32_t mathkong_bf16_to_f32_implementation(mathkong_bf16_t const *x_ptr) {
    unsigned short x;
    SIMSIMD_COPY16(&x, x_ptr);
    mathkong_fui32_t conv;
 ...
 *  https://cloud.google.com/blog/products/ai-machine-learning/bfloat16-the-secret-to-high-performance-on-cloud-tpus
 */
SIMSIMD_INTERNAL void mathkong_f32_to_bf16_implementation(mathkong_f32_t x, mathkong_bf16_t *result_ptr) {
    mathkong_fui32_t conv;
    conv.f = x;
...
SIMSIMD_INTERNAL void _mathkong_f16_to_f64(mathkong_f16_t const *x, mathkong_f64_t *y) {
    mathkong_f32_t f32;
    mathkong_f16_to_f32(x, &f32);
    *y = (mathkong_f64_t)f32;
}
SIMSIMD_INTERNAL void _mathkong_f64_to_f16(mathkong_f64_t const *x, mathkong_f16_t *y) {
    mathkong_f32_t f32 = (mathkong_f32_t)*x;
    mathkong_f32_to_f16(&f32, y);
}
SIMSIMD_INTERNAL void _mathkong_bf16_to_f64(mathkong_bf16_t const *x, mathkong_f64_t *y) {
    mathkong_f32_t f32;
    mathkong_bf16_to_f32(x, &f32);
    *y = (mathkong_f64_t)f32;
}
SIMSIMD_INTERNAL void _mathkong_f64_to_bf16(mathkong_f64_t const *x, mathkong_bf16_t *y) {
    mathkong_f32_t f32 = (mathkong_f32_t)*x;
 ...
 */
SIMSIMD_INTERNAL void _mathkong_f32_to_i8(mathkong_f32_t const *x, mathkong_i8_t *y) {
    *y = (mathkong_i8_t)(*x > 127 ? 127 : (*x < -128 ? -128 : (int)(*x + (*x < 0 ? -0.5f : 0.5f))));
}

SIMSIMD_INTERNAL void _mathkong_f32_to_u8(mathkong_f32_t const *x, mathkong_u8_t *y) {
    *y = (mathkong_u8_t)(*x > 255 ? 255 : (*x < 0 ? 0 : (int)(*x + (*x < 0 ? -0.5f : 0.5f))));
}

SIMSIMD_INTERNAL void _mathkong_f32_to_i16(mathkong_f32_t const *x, mathkong_i16_t *y) {
    *y = (mathkong_i16_t)(*x > 32767 ? 32767 : (*x < -32768 ? -32768 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f32_to_u16(mathkong_f32_t const *x, mathkong_u16_t *y) {
    *y = (mathkong_u16_t)(*x > 65535 ? 65535 : (*x < 0 ? 0 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_i8(mathkong_f64_t const *x, mathkong_i8_t *y) {
    *y = (mathkong_i8_t)(*x > 127 ? 127 : (*x < -128 ? -128 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_u8(mathkong_f64_t const *x, mathkong_u8_t *y) {
    *y = (mathkong_u8_t)(*x > 255 ? 255 : (*x < 0 ? 0 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_i16(mathkong_f64_t const *x, mathkong_i16_t *y) {
    *y = (mathkong_i16_t)(*x > 32767 ? 32767 : (*x < -32768 ? -32768 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_u16(mathkong_f64_t const *x, mathkong_u16_t *y) {
    *y = (mathkong_u16_t)(*x > 65535 ? 65535 : (*x < 0 ? 0 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_i32(mathkong_f64_t const *x, mathkong_i32_t *y) {
    *y = (mathkong_i32_t)(*x > 2147483647 ? 2147483647
                                          : (*x < -2147483648 ? -2147483648 : (int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_u32(mathkong_f64_t const *x, mathkong_u32_t *y) {
    *y = (mathkong_u32_t)(*x > 4294967295 ? 4294967295 : (*x < 0 ? 0 : (unsigned int)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_f64_to_i64(mathkong_f64_t const *x, mathkong_i64_t *y) {
...
SIMSIMD_INTERNAL void _mathkong_f64_to_u64(mathkong_f64_t const *x, mathkong_u64_t *y) {
    *y =
        (mathkong_u64_t)(*x > 18446744073709551615.0 ? 18446744073709551615ull
                                                     : (*x < 0 ? 0 : (unsigned long long)(*x + (*x < 0 ? -0.5 : 0.5))));
}

SIMSIMD_INTERNAL void _mathkong_i64_to_i8(mathkong_i64_t const *x, mathkong_i8_t *y) {
    *y = (mathkong_i8_t)(*x > 127ll ? 127ll : (*x < -128ll ? -128ll : *x));
}

SIMSIMD_INTERNAL void _mathkong_i64_to_u8(mathkong_i64_t const *x, mathkong_u8_t *y) {
    *y = (mathkong_u8_t)(*x > 255ll ? 255ll : (*x < 0ll ? 0ll : *x));
}

SIMSIMD_INTERNAL void _mathkong_i64_to_i16(mathkong_i64_t const *x, mathkong_i16_t *y) {
    *y = (mathkong_i16_t)(*x > 32767ll ? 32767ll : (*x < -32768ll ? -32768ll : *x));
}

SIMSIMD_INTERNAL void _mathkong_i64_to_u16(mathkong_i64_t const *x, mathkong_u16_t *y) {
    *y = (mathkong_u16_t)(*x > 65535ll ? 65535ll : (*x < 0ll ? 0ll : *x));
}

SIMSIMD_INTERNAL void _mathkong_i64_to_i32(mathkong_i64_t const *x, mathkong_i32_t *y) {
    *y = (mathkong_i32_t)(*x > 2147483647ll ? 2147483647ll : (*x < -2147483648ll ? -2147483648ll : *x));
}

SIMSIMD_INTERNAL void _mathkong_i64_to_u32(mathkong_i64_t const *x, mathkong_u32_t *y) {
    *y = (mathkong_u32_t)(*x > 4294967295ll ? 4294967295ll : (*x < 0ll ? 0ll : *x));
}

SIMSIMD_INTERNAL void _mathkong_u64_to_i8(mathkong_u64_t const *x, mathkong_i8_t *y) {
    *y = (mathkong_i8_t)(*x > 127ull ? 127ull : *x);
}

SIMSIMD_INTERNAL void _mathkong_u64_to_u8(mathkong_u64_t const *x, mathkong_u8_t *y) {
    *y = (mathkong_u8_t)(*x > 255ull ? 255ull : *x);
}

SIMSIMD_INTERNAL void _mathkong_u64_to_i16(mathkong_u64_t const *x, mathkong_i16_t *y) {
    *y = (mathkong_i16_t)(*x > 32767ull ? 32767ull : *x);
}

SIMSIMD_INTERNAL void _mathkong_u64_to_u16(mathkong_u64_t const *x, mathkong_u16_t *y) {
    *y = (mathkong_u16_t)(*x > 65535ull ? 65535ull : *x);
}

SIMSIMD_INTERNAL void _mathkong_u64_to_i32(mathkong_u64_t const *x, mathkong_i32_t *y) {
    *y = (mathkong_i32_t)(*x > 2147483647ull ? 2147483647ull : *x);
}

SIMSIMD_INTERNAL void _mathkong_u64_to_u32(mathkong_u64_t const *x, mathkong_u32_t *y) {
    *y = (mathkong_u32_t)(*x > 4294967295ull ? 4294967295ull : *x);
}

SIMSIMD_INTERNAL void _mathkong_f64_to_f32(mathkong_f64_t const *x, mathkong_f32_t *y) { *y = (mathkong_f32_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u64_to_f32(mathkong_u64_t const *x, mathkong_f32_t *y) { *y = (mathkong_f32_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i64_to_f32(mathkong_i64_t const *x, mathkong_f32_t *y) { *y = (mathkong_f32_t)*x; }

SIMSIMD_INTERNAL void _mathkong_f32_to_f64(mathkong_f32_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }

SIMSIMD_INTERNAL void _mathkong_f64_to_f64(mathkong_f64_t const *x, mathkong_f64_t *y) { *y = *x; }

SIMSIMD_INTERNAL void _mathkong_i8_to_f64(mathkong_i8_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i16_to_f64(mathkong_i16_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i32_to_f64(mathkong_i32_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i64_to_f64(mathkong_i64_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u8_to_f64(mathkong_u8_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u16_to_f64(mathkong_u16_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u32_to_f64(mathkong_u32_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u64_to_f64(mathkong_u64_t const *x, mathkong_f64_t *y) { *y = (mathkong_f64_t)*x; }

SIMSIMD_INTERNAL void _mathkong_i8_to_i64(mathkong_i8_t const *x, mathkong_i64_t *y) { *y = (mathkong_i64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i16_to_i64(mathkong_i16_t const *x, mathkong_i64_t *y) { *y = (mathkong_i64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i32_to_i64(mathkong_i32_t const *x, mathkong_i64_t *y) { *y = (mathkong_i64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_i64_to_i64(mathkong_i64_t const *x, mathkong_i64_t *y) { *y = *x; }
SIMSIMD_INTERNAL void _mathkong_u8_to_i64(mathkong_u8_t const *x, mathkong_i64_t *y) { *y = (mathkong_i64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u16_to_i64(mathkong_u16_t const *x, mathkong_i64_t *y) { *y = (mathkong_i64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u32_to_i64(mathkong_u32_t const *x, mathkong_i64_t *y) { *y = (mathkong_i64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u64_to_i64(mathkong_u64_t const *x, mathkong_i64_t *y) {
    *y = (mathkong_i64_t)(*x >= 9223372036854775807ull ? 9223372036854775807ll : *x);
}

SIMSIMD_INTERNAL void _mathkong_i8_to_u64(mathkong_i8_t const *x, mathkong_u64_t *y) {
    *y = (mathkong_u64_t)(*x < 0 ? 0 : *x);
}
SIMSIMD_INTERNAL void _mathkong_i16_to_u64(mathkong_i16_t const *x, mathkong_u64_t *y) {
    *y = (mathkong_u64_t)(*x < 0 ? 0 : *x);
}
SIMSIMD_INTERNAL void _mathkong_i32_to_u64(mathkong_i32_t const *x, mathkong_u64_t *y) {
    *y = (mathkong_u64_t)(*x < 0 ? 0 : *x);
}
SIMSIMD_INTERNAL void _mathkong_i64_to_u64(mathkong_i64_t const *x, mathkong_u64_t *y) {
    *y = (mathkong_u64_t)(*x < 0 ? 0 : *x);
}
SIMSIMD_INTERNAL void _mathkong_u8_to_u64(mathkong_u8_t const *x, mathkong_u64_t *y) { *y = (mathkong_u64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u16_to_u64(mathkong_u16_t const *x, mathkong_u64_t *y) { *y = (mathkong_u64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u32_to_u64(mathkong_u32_t const *x, mathkong_u64_t *y) { *y = (mathkong_u64_t)*x; }
SIMSIMD_INTERNAL void _mathkong_u64_to_u64(mathkong_u64_t const *x, mathkong_u64_t *y) { *y = *x; }

SIMSIMD_INTERNAL void _mathkong_i64_to_f16(mathkong_i64_t const *x, mathkong_f16_t *y) {
    mathkong_f32_t f32 = (mathkong_f32_t)*x;
    mathkong_f32_to_f16(&f32, y);
}
SIMSIMD_INTERNAL void _mathkong_i64_to_bf16(mathkong_i64_t const *x, mathkong_bf16_t *y) {
    mathkong_f32_t f32 = (mathkong_f32_t)*x;
    mathkong_f32_to_bf16(&f32, y);
}
SIMSIMD_INTERNAL void _mathkong_u64_to_f16(mathkong_u64_t const *x, mathkong_f16_t *y) {
    mathkong_f32_t f32 = (mathkong_f32_t)*x;
    mathkong_f32_to_f16(&f32, y);
}
SIMSIMD_INTERNAL void _mathkong_u64_to_bf16(mathkong_u64_t const *x, mathkong_bf16_t *y) {
    mathkong_f32_t f32 = (mathkong_f32_t)*x;
    mathkong_f32_to_bf16(&f32, y);
}
 ...
 */
SIMSIMD_INTERNAL void *_mathkong_advance_by_bytes(void *ptr, mathkong_size_t bytes) {
 ...
 */
SIMSIMD_INTERNAL mathkong_size_t _mathkong_divide_ceil(mathkong_size_t dividend, mathkong_size_t divisor) {
 ...
 */
SIMSIMD_PUBLIC int mathkong_xd_index_next(                                                 //
 ...
 */
SIMSIMD_PUBLIC int mathkong_xd_index_linearize(                                            //
    mathkong_size_t const *extents, mathkong_ssize_t const *strides, mathkong_size_t rank, //
...
typedef struct mathkong_xd_index_t {
    mathkong_size_t coordinates[SIMSIMD_NDARRAY_MAX_RANK]; // Coordinate offsets along each dimension
    mathkong_ssize_t byte_offset;                          // Byte offset of the current element
} mathkong_xd_index_t;

SIMSIMD_PUBLIC void mathkong_xd_index_init(mathkong_xd_index_t *xd_index) {
    for (mathkong_size_t i = 0; i < SIMSIMD_NDARRAY_MAX_RANK; i++) xd_index->coordinates[i] = 0;
...
typedef struct mathkong_xd_span_t {
    mathkong_size_t extents[SIMSIMD_NDARRAY_MAX_RANK];  /// Number of elements along each dimension
    mathkong_ssize_t strides[SIMSIMD_NDARRAY_MAX_RANK]; /// Strides of the tensor in bytes
    mathkong_size_t rank;                               /// Number of dimensions in the tensor
} mathkong_xd_span_t;

SIMSIMD_PUBLIC void mathkong_xd_span_init(mathkong_xd_span_t *xd_span) {
    for (mathkong_size_t i = 0; i < SIMSIMD_NDARRAY_MAX_RANK; i++) xd_span->extents[i] = 0, xd_span->strides[i] = 0;
    xd_span->rank = 0;
}

SIMSIMD_INTERNAL mathkong_u32_t _mathkong_u32_rol(mathkong_u32_t *x, int n) { return (*x << n) | (*x >> (32 - n)); }
SIMSIMD_INTERNAL mathkong_u16_t _mathkong_u16_rol(mathkong_u16_t *x, int n) { return (*x << n) | (*x >> (16 - n)); }
SIMSIMD_INTERNAL mathkong_u8_t _mathkong_u8_rol(mathkong_u8_t *x, int n) { return (*x << n) | (*x >> (8 - n)); }
SIMSIMD_INTERNAL mathkong_u32_t _mathkong_u32_ror(mathkong_u32_t *x, int n) { return (*x >> n) | (*x << (32 - n)); }
SIMSIMD_INTERNAL mathkong_u16_t _mathkong_u16_ror(mathkong_u16_t *x, int n) { return (*x >> n) | (*x << (16 - n)); }
SIMSIMD_INTERNAL mathkong_u8_t _mathkong_u8_ror(mathkong_u8_t *x, int n) { return (*x >> n) | (*x << (8 - n)); }

SIMSIMD_INTERNAL void _mathkong_u8_sadd(mathkong_u8_t const *a, mathkong_u8_t const *b, mathkong_u8_t *r) {
    mathkong_u16_t result = (mathkong_u16_t)*a + (mathkong_u16_t)*b;
    *r = (result > 255u) ? (mathkong_u8_t)255u : (mathkong_u8_t)result;
}
SIMSIMD_INTERNAL void _mathkong_u16_sadd(mathkong_u16_t const *a, mathkong_u16_t const *b, mathkong_u16_t *r) {
    mathkong_u32_t result = (mathkong_u32_t)*a + (mathkong_u32_t)*b;
    *r = (result > 65535u) ? (mathkong_u16_t)65535u : (mathkong_u16_t)result;
}
SIMSIMD_INTERNAL void _mathkong_u32_sadd(mathkong_u32_t const *a, mathkong_u32_t const *b, mathkong_u32_t *r) {
...
SIMSIMD_INTERNAL void _mathkong_u64_sadd(mathkong_u64_t const *a, mathkong_u64_t const *b, mathkong_u64_t *r) {
    *r = (*a + *b < *a) ? 18446744073709551615ull : (*a + *b);
}
SIMSIMD_INTERNAL void _mathkong_i8_sadd(mathkong_i8_t const *a, mathkong_i8_t const *b, mathkong_i8_t *r) {
    mathkong_i16_t result = (mathkong_i16_t)*a + (mathkong_i16_t)*b;
    *r = (result > 127) ? 127 : (result < -128 ? -128 : result);
}
SIMSIMD_INTERNAL void _mathkong_i16_sadd(mathkong_i16_t const *a, mathkong_i16_t const *b, mathkong_i16_t *r) {
    mathkong_i32_t result = (mathkong_i32_t)*a + (mathkong_i32_t)*b;
    *r = (result > 32767) ? 32767 : (result < -32768 ? -32768 : result);
}
SIMSIMD_INTERNAL void _mathkong_i32_sadd(mathkong_i32_t const *a, mathkong_i32_t const *b, mathkong_i32_t *r) {
...
SIMSIMD_INTERNAL void _mathkong_i64_sadd(mathkong_i64_t const *a, mathkong_i64_t const *b, mathkong_i64_t *r) {
...
SIMSIMD_INTERNAL void _mathkong_f32_sadd(mathkong_f32_t const *a, mathkong_f32_t const *b, mathkong_f32_t *r) {
    *r = *a + *b;
}
SIMSIMD_INTERNAL void _mathkong_f64_sadd(mathkong_f64_t const *a, mathkong_f64_t const *b, mathkong_f64_t *r) {
    *r = *a + *b;
}
SIMSIMD_INTERNAL void _mathkong_f16_sadd(mathkong_f16_t const *a, mathkong_f16_t const *b, mathkong_f16_t *r) {
...
SIMSIMD_INTERNAL void _mathkong_bf16_sadd(mathkong_bf16_t const *a, mathkong_bf16_t const *b, mathkong_bf16_t *r) {
    mathkong_f32_t a_f32, b_f32, r_f32;
...
SIMSIMD_INTERNAL void _mathkong_u8_smul(mathkong_u8_t const *a, mathkong_u8_t const *b, mathkong_u8_t *r) {
    mathkong_u16_t result = (mathkong_u16_t)(*a) * (mathkong_u16_t)(*b);
    *r = (result > 255) ? 255 : (mathkong_u8_t)result;
}

SIMSIMD_INTERNAL void _mathkong_u16_smul(mathkong_u16_t const *a, mathkong_u16_t const *b, mathkong_u16_t *r) {
    mathkong_u32_t result = (mathkong_u32_t)(*a) * (mathkong_u32_t)(*b);
    *r = (result > 65535) ? 65535 : (mathkong_u16_t)result;
}

SIMSIMD_INTERNAL void _mathkong_u32_smul(mathkong_u32_t const *a, mathkong_u32_t const *b, mathkong_u32_t *r) {
    mathkong_u64_t result = (mathkong_u64_t)(*a) * (mathkong_u64_t)(*b);
    *r = (result > 4294967295u) ? 4294967295u : (mathkong_u32_t)result;
}

SIMSIMD_INTERNAL void _mathkong_u64_smul(mathkong_u64_t const *a, mathkong_u64_t const *b, mathkong_u64_t *r) {
...
SIMSIMD_INTERNAL void _mathkong_i8_smul(mathkong_i8_t const *a, mathkong_i8_t const *b, mathkong_i8_t *r) {
    mathkong_i16_t result = (mathkong_i16_t)(*a) * (mathkong_i16_t)(*b);
    *r = (result > 127) ? 127 : (result < -128 ? -128 : (mathkong_i8_t)result);
}

SIMSIMD_INTERNAL void _mathkong_i16_smul(mathkong_i16_t const *a, mathkong_i16_t const *b, mathkong_i16_t *r) {
    mathkong_i32_t result = (mathkong_i32_t)(*a) * (mathkong_i32_t)(*b);
    *r = (result > 32767) ? 32767 : (result < -32768 ? -32768 : (mathkong_i16_t)result);
}

SIMSIMD_INTERNAL void _mathkong_i32_smul(mathkong_i32_t const *a, mathkong_i32_t const *b, mathkong_i32_t *r) {
    mathkong_i64_t result = (mathkong_i64_t)(*a) * (mathkong_i64_t)(*b);
    *r = (result > 2147483647ll) ? 2147483647ll : (result < -2147483648ll ? -2147483648ll : (mathkong_i32_t)result);
}

SIMSIMD_INTERNAL void _mathkong_i64_smul(mathkong_i64_t const *a, mathkong_i64_t const *b, mathkong_i64_t *r) {
...
SIMSIMD_INTERNAL void _mathkong_f32_smul(mathkong_f32_t const *a, mathkong_f32_t const *b, mathkong_f32_t *r) {
    *r = *a * *b;
}

SIMSIMD_INTERNAL void _mathkong_f64_smul(mathkong_f64_t const *a, mathkong_f64_t const *b, mathkong_f64_t *r) {
    *r = *a * *b;
}

SIMSIMD_INTERNAL void _mathkong_f16_smul(mathkong_f16_t const *a, mathkong_f16_t const *b, mathkong_f16_t *r) {
    mathkong_f32_t a_f32, b_f32, r_f32;
    mathkong_f16_to_f32(a, &a_f32);
    mathkong_f16_to_f32(b, &b_f32);
    r_f32 = a_f32 * b_f32;
...
SIMSIMD_INTERNAL void _mathkong_bf16_smul(mathkong_bf16_t const *a, mathkong_bf16_t const *b, mathkong_bf16_t *r) {
    mathkong_f32_t a_f32, b_f32, r_f32;
    mathkong_bf16_to_f32(a, &a_f32);
    mathkong_bf16_to_f32(b, &b_f32);
    r_f32 = a_f32 * b_f32;
...
/** @copydoc mathkong_f16_to_f32_implementation */
SIMSIMD_PUBLIC mathkong_f32_t mathkong_f16_to_f32(mathkong_f16_t const *x_ptr) {
    return mathkong_f16_to_f32_implementation(x_ptr);
}

/** @copydoc mathkong_f32_to_f16_implementation */
SIMSIMD_PUBLIC void mathkong_f32_to_f16(mathkong_f32_t x, mathkong_f16_t *result_ptr) {
    mathkong_f32_to_f16_implementation(x, result_ptr);
}

/** @copydoc mathkong_bf16_to_f32_implementation */
SIMSIMD_PUBLIC mathkong_f32_t mathkong_bf16_to_f32(mathkong_bf16_t const *x_ptr) {
    return mathkong_bf16_to_f32_implementation(x_ptr);
}

/** @copydoc mathkong_f32_to_bf16_implementation */
SIMSIMD_PUBLIC void mathkong_f32_to_bf16(mathkong_f32_t x, mathkong_bf16_t *result_ptr) {
