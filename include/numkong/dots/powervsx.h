...
nk_define_cross_pack_(dots, f32, powervsx, f32, f32, nk_assign_from_to_, /*norm_value_type=*/f64,
...
nk_define_cross_pack_(dots, u1, powervsx, u1x8, u1x8, nk_assign_from_to_, /*norm_value_type=*/u32,
...
nk_define_cross_pack_size_(dots, bf16, powervsx, bf16, bf16, /*norm_value_type=*/f32, /*depth_simd_dimensions=*/8,
                           /*dimensions_per_value=*/1)
nk_define_cross_pack_(dots, bf16, powervsx, bf16, bf16, nk_assign_from_to_, /*norm_value_type=*/f32,
...
nk_define_cross_pack_size_(dots, u8, powervsx, u8, u8, /*norm_value_type=*/u32, /*depth_simd_dimensions=*/16,
                           /*dimensions_per_value=*/1)
nk_define_cross_pack_(dots, u8, powervsx, u8, u8, nk_assign_from_to_, /*norm_value_type=*/u32, nk_dots_reduce_sumsq_u8_,
                      /*depth_simd_dimensions=*/16,
                      /*dimensions_per_value=*/1)
...
nk_define_cross_pack_size_(dots, f64, powervsx, f64, f64, /*norm_value_type=*/f64, /*depth_simd_dimensions=*/2,
                           /*dimensions_per_value=*/1)
nk_define_cross_pack_(dots, f64, powervsx, f64, f64, nk_assign_from_to_, /*norm_value_type=*/f64,
