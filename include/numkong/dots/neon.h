...
nk_define_dots_pack_size_(f32, neon, f32, f32, f32, /*depth_simd_dimensions=*/2, /*dimensions_per_value=*/1)
nk_define_dots_pack_(f32, neon, f32, f32, f32, nk_assign_from_to_, /*depth_simd_dimensions=*/2,
...
nk_define_dots_pack_size_(f64, neon, f64, f64, f64, /*depth_simd_dimensions=*/2, /*dimensions_per_value=*/1)
nk_define_dots_pack_(f64, neon, f64, f64, f64, nk_assign_from_to_, /*depth_simd_dimensions=*/2,
                     /*dimensions_per_value=*/1)
