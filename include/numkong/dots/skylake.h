...
/* F64 GEMM: depth_simd_step=8 (8 f64s = 64 bytes = 1 cache line) */
nk_define_dots_pack_size_(f64, skylake, f64, f64, f64, /*depth_simd_step=*/8)
nk_define_dots_pack_(f64, skylake, f64, f64, f64, nk_assign_from_to_, /*depth_simd_step=*/8)
...
/* F32 GEMM: depth_simd_step=8 (8 f32s = 32 bytes = half cache line) */
nk_define_dots_pack_size_(f32, skylake, f32, f32, f32, /*depth_simd_step=*/8)
nk_define_dots_pack_(f32, skylake, f32, f32, f32, nk_assign_from_to_, /*depth_simd_step=*/8)
...
/* BF16 GEMM: depth_simd_step=16 (16 bf16s = 32 bytes = half cache line), F32 accumulator */
nk_define_dots_pack_size_(bf16, skylake, bf16, f32, f32, /*depth_simd_step=*/16)
nk_define_dots_pack_(bf16, skylake, bf16, f32, f32, nk_bf16_to_f32, /*depth_simd_step=*/16)
...
/* F16 GEMM: depth_simd_step=16 (16 f16s = 32 bytes = half cache line), F32 accumulator */
nk_define_dots_pack_size_(f16, skylake, f16, f32, f32, /*depth_simd_step=*/16)
nk_define_dots_pack_(f16, skylake, f16, f32, f32, nk_f16_to_f32, /*depth_simd_step=*/16)
...
/* E4M3 GEMM: depth_simd_step=16 (16 e4m3s = 16 bytes = quarter cache line), F32 accumulator */
nk_define_dots_pack_size_(e4m3, skylake, e4m3, e4m3, f32, /*depth_simd_step=*/16)
nk_define_dots_pack_(e4m3, skylake, e4m3, f32, f32, nk_e4m3_to_f32, /*depth_simd_step=*/16)
...
/* E5M2 GEMM: depth_simd_step=16 (16 e5m2s = 16 bytes = quarter cache line), F32 accumulator */
nk_define_dots_pack_size_(e5m2, skylake, e5m2, e5m2, f32, /*depth_simd_step=*/16)
nk_define_dots_pack_(e5m2, skylake, e5m2, f32, f32, nk_e5m2_to_f32, /*depth_simd_step=*/16)
