...
NK_MAKE_DOTS_PACK_SIZE(haswell, f32, f32, 8)
NK_MAKE_DOTS_PACK(haswell, f32, f32, 8)
...
NK_MAKE_DOTS_PACK_SIZE(haswell, f16, f32, 16)
NK_MAKE_DOTS_PACK(haswell, f16, f32, 16)
...
NK_MAKE_DOTS_PACK_SIZE(haswell, bf16, f32, 16)
NK_MAKE_DOTS_PACK(haswell, bf16, f32, 16)
...
NK_MAKE_DOTS_PACK_SIZE(haswell, e4m3, f32, 32)
NK_MAKE_DOTS_PACK(haswell, e4m3, f32, 32)
...
NK_MAKE_DOTS_PACK_SIZE(haswell, e5m2, f32, 32)
NK_MAKE_DOTS_PACK(haswell, e5m2, f32, 32)
...
NK_MAKE_DOTS_PACK_SIZE(haswell, i8, i32, 32)
NK_MAKE_DOTS_PACK(haswell, i8, i32, 32)
...
NK_MAKE_DOTS_PACK_SIZE(haswell, u8, i32, 32)
NK_MAKE_DOTS_PACK(haswell, u8, i32, 32)
