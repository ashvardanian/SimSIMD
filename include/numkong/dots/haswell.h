...
nk_define_dots_pack_size_(f32, haswell, f32, f32, f32, /*depth_simd_dimensions=*/4, /*dimensions_per_value=*/1)
nk_define_dots_pack_(f32, haswell, f32, f32, f32, nk_assign_from_to_, /*depth_simd_dimensions=*/4,
...
nk_define_dots_pack_size_(f64, haswell, f64, f64, f64, /*depth_simd_dimensions=*/4, /*dimensions_per_value=*/1)
nk_define_dots_pack_(f64, haswell, f64, f64, f64, nk_assign_from_to_, /*depth_simd_dimensions=*/4,
                     /*dimensions_per_value=*/1)
...
nk_define_dots_pack_size_(f16, haswell, f16, f32, f32, /*depth_simd_dimensions=*/8, /*dimensions_per_value=*/1)
nk_define_dots_pack_(f16, haswell, f16, f32, f32, nk_f16_to_f32, /*depth_simd_dimensions=*/8,
...
nk_define_dots_pack_size_(bf16, haswell, bf16, f32, f32, /*depth_simd_dimensions=*/8, /*dimensions_per_value=*/1)
nk_define_dots_pack_(bf16, haswell, bf16, f32, f32, nk_bf16_to_f32, /*depth_simd_dimensions=*/8,
                     /*dimensions_per_value=*/1) // Store as F32
...
nk_define_dots_pack_size_(e4m3, haswell, e4m3, e4m3, f32, /*depth_simd_dimensions=*/8, /*dimensions_per_value=*/1)
nk_define_dots_pack_(e4m3, haswell, e4m3, e4m3, f32, nk_assign_from_to_, /*depth_simd_dimensions=*/8,
                     /*dimensions_per_value=*/1)
...
nk_define_dots_pack_size_(e5m2, haswell, e5m2, e5m2, f32, /*depth_simd_dimensions=*/8, /*dimensions_per_value=*/1)
nk_define_dots_pack_(e5m2, haswell, e5m2, e5m2, f32, nk_assign_from_to_, /*depth_simd_dimensions=*/8,
                     /*dimensions_per_value=*/1)
...
nk_define_dots_pack_size_(i8, haswell, i8, i8, i32, /*depth_simd_dimensions=*/16, /*dimensions_per_value=*/1)
nk_define_dots_pack_(i8, haswell, i8, i8, i32, nk_assign_from_to_, /*depth_simd_dimensions=*/16,
                     /*dimensions_per_value=*/1)
...
nk_define_dots_pack_size_(u8, haswell, u8, u8, u32, /*depth_simd_dimensions=*/16, /*dimensions_per_value=*/1)
nk_define_dots_pack_(u8, haswell, u8, u8, u32, nk_assign_from_to_, /*depth_simd_dimensions=*/16,
                     /*dimensions_per_value=*/1)
