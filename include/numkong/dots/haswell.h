...
nk_define_cross_symmetric_(dots, e2m3, haswell, e2m3, f32, nk_b256_vec_t, nk_dot_e2m3x32_state_haswell_t, nk_b128_vec_t,
                           ...
                           nk_dot_e2m3x32_update_haswell, nk_dot_e2m3x32_finalize_haswell,
                           nk_partial_store_b32x4_serial_,
                           /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/1)
nk_define_cross_packed_(dots, e2m3, haswell, e2m3, e2m3, f32, nk_b256_vec_t, nk_dot_e2m3x32_state_haswell_t,
                        ...
                        nk_dot_e2m3x32_update_haswell, nk_dot_e2m3x32_finalize_haswell, nk_partial_store_b32x4_serial_,
                        /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/1)
...
nk_define_cross_symmetric_(dots, e3m2, haswell, e3m2, f32, nk_b256_vec_t, nk_dot_e3m2x32_state_haswell_t, nk_b128_vec_t,
                           ...
                           nk_dot_e3m2x32_update_haswell, nk_dot_e3m2x32_finalize_haswell,
                           nk_partial_store_b32x4_serial_,
                           /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/1)
nk_define_cross_packed_(dots, e3m2, haswell, e3m2, e3m2, f32, nk_b256_vec_t, nk_dot_e3m2x32_state_haswell_t,
                        ...
                        nk_partial_load_b8x32_serial_, nk_load_b256_haswell_, nk_partial_load_b8x32_serial_,
                        nk_dot_e3m2x32_update_haswell, nk_dot_e3m2x32_finalize_haswell, nk_partial_store_b32x4_serial_,
                        /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/1)
...
nk_define_cross_compensated_symmetric_(
    dots, i4, haswell, i4x2, i32,
    /*sum_value_type=*/i32, /*norm_value_type=*/u32, nk_b128_vec_t, nk_dot_i4x32_state_haswell_t, nk_b128_vec_t,
    nk_dot_i4x32_init_haswell, nk_load_b128_haswell_, nk_partial_load_b4x32_serial_, nk_dot_i4x32_update_haswell,
    nk_dot_i4x32_finalize_haswell, nk_partial_store_b32x4_serial_, nk_load_b128_haswell_, nk_partial_load_b32x4_serial_,
    nk_sum_i4x32_state_serial_t, nk_sum_i4x32_init_serial, nk_sum_i4x32_update_serial, nk_sum_i4x32_finalize_serial,
    /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/2)
...
nk_define_cross_symmetric_(dots, u1, haswell, u1x8, u32, nk_b128_vec_t, nk_dot_u1x128_state_haswell_t, nk_b128_vec_t,
                           ...
                           nk_dot_u1x128_update_haswell, nk_dot_u1x128_finalize_haswell, nk_partial_store_b32x4_serial_,
                           /*depth_simd_dimensions=*/128, /*dimensions_per_value=*/8)
nk_define_cross_packed_(dots, u1, haswell, u1x8, u1x8, u32, nk_b128_vec_t, nk_dot_u1x128_state_haswell_t, nk_b128_vec_t,
                        ...
                        nk_dot_u1x128_finalize_haswell, nk_partial_store_b32x4_serial_,
                        /*depth_simd_dimensions=*/128, /*dimensions_per_value=*/8)
