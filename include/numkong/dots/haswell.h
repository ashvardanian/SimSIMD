...
nk_define_cross_pack_size_(dots, e2m3, haswell, e2m3, e2m3, /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/1)
nk_define_cross_pack_(dots, e2m3, haswell, e2m3, e2m3, nk_assign_from_to_, /*depth_simd_dimensions=*/32,
                      /*dimensions_per_value=*/1)
...
nk_define_cross_pack_size_(dots, e3m2, haswell, e3m2, e3m2, /*depth_simd_dimensions=*/32, /*dimensions_per_value=*/1)
nk_define_cross_pack_(dots, e3m2, haswell, e3m2, e3m2, nk_assign_from_to_, /*depth_simd_dimensions=*/32,
                      /*dimensions_per_value=*/1)
