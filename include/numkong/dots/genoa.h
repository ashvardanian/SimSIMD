...
nk_define_dots_pack_size_(genoa, bf16, bf16, f32)
nk_define_dots_pack_(genoa, bf16, bf16, f32, nk_assign_from_to_)
nk_define_dots_symmetric_(bf16_genoa, bf16, f32, nk_b512_vec_t, nk_dot_through_bf16_state_genoa_t_, nk_b128_vec_t,
                          ...
                          /*simd_width=*/32)
nk_define_dots_packed_(bf16_genoa, bf16, bf16, f32, nk_b512_vec_t, nk_dot_through_bf16_state_genoa_t_, nk_b128_vec_t,
                       nk_dot_through_bf16_init_genoa_, nk_load_b512_skylake_, nk_partial_load_b16x32_skylake_,
...
nk_define_dots_pack_size_(genoa, e4m3, e4m3, f32)
nk_define_dots_pack_(genoa, e4m3, bf16, f32, nk_e4m3_to_bf16)
nk_define_dots_symmetric_(e4m3_genoa, e4m3, f32, nk_b512_vec_t, nk_dot_through_bf16_state_genoa_t_, nk_b128_vec_t,
                          ...
                          /*simd_width=*/32)
nk_define_dots_packed_(e4m3_genoa, e4m3, bf16, f32, nk_b512_vec_t, nk_dot_through_bf16_state_genoa_t_, nk_b128_vec_t,
                       nk_dot_through_bf16_init_genoa_, nk_load_e4m3x32_to_bf16x32_genoa_,
...
nk_define_dots_pack_size_(genoa, e5m2, e5m2, f32)
nk_define_dots_pack_(genoa, e5m2, bf16, f32, nk_e5m2_to_bf16)
nk_define_dots_symmetric_(e5m2_genoa, e5m2, f32, nk_b512_vec_t, nk_dot_through_bf16_state_genoa_t_, nk_b128_vec_t,
                          ...
                          nk_dot_through_bf16_finalize_genoa_,
                          /*simd_width=*/32)
nk_define_dots_packed_(e5m2_genoa, e5m2, bf16, f32, nk_b512_vec_t, nk_dot_through_bf16_state_genoa_t_, nk_b128_vec_t,
                       nk_dot_through_bf16_init_genoa_, nk_load_e5m2x32_to_bf16x32_genoa_,
