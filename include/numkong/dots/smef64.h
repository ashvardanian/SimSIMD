 ...
 */
NK_INTERNAL nk_u64_t nk_f64_smef64_ozaki_mask_19_bits_(void) NK_STREAMING_COMPATIBLE_ {
    return 0xFFFFFFFC00000000ULL; // keep top 19 sig bits
}
NK_INTERNAL nk_u64_t nk_f64_smef64_ozaki_mask_17_bits_(void) NK_STREAMING_COMPATIBLE_ {
