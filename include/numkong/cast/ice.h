...
NK_INTERNAL __m512i nk_e2m3x32_to_bf16x32_ice_(__m256i e2m3x32) {
    ...
    __m512i const lut_i16x32 = _mm512_set_epi16(                         //
        ...
        0x3F60, 0x3F40, 0x3F20, 0x3F00, 0x3EC0, 0x3E80, 0x3E00, 0x0000); // [7-0] exp=0: subnormals
...
NK_INTERNAL __m512i nk_e3m2x32_to_bf16x32_ice_(__m256i e3m2x32) {
    ...
    __m512i const lut_i16x32 = _mm512_set_epi16( //
        ...
        0x40E0, 0x40C0, 0x40A0, 0x4080,          // [27-24] exp=6, mant=3-0: bf16_exp=130
        0x3FE0, 0x3FC0, 0x3FA0, 0x3F80,          // [23-20] exp=5, mant=3-0: bf16_exp=129
        0x3EE0, 0x3EC0, 0x3EA0, 0x3E80,          // [19-16] exp=4, mant=3-0: bf16_exp=128
        0x3DE0, 0x3DC0, 0x3DA0, 0x3D80,          // [15-12] exp=3, mant=3-0: bf16_exp=127
        0x3CE0, 0x3CC0, 0x3CA0, 0x3C80,          // [11-8] exp=2, mant=3-0: bf16_exp=126
        0x3BE0, 0x3BC0, 0x3BA0, 0x3B80,          // [7-4] exp=1, mant=3-0: bf16_exp=125
        0x3B40, 0x3B00, 0x3A80, 0x0000);         // [3-0] exp=0, mant=3-0: subnormals
...
NK_INTERNAL __m512i nk_e4m3x32_to_f16x32_ice_(__m256i e4m3x32) {
    ...
    // NaN (idx 127): 0x7E00
    __m512i const lut0_i16x32 = _mm512_set_epi16(                        // indices 0-31
        0x0000, 0x1800, 0x1C00, 0x1E00, 0x2000, 0x2100, 0x2200, 0x2300,  // idx 31-24
        0x2400, 0x2480, 0x2500, 0x2580, 0x2600, 0x2680, 0x2700, 0x2780,  // idx 23-16
        0x2800, 0x2880, 0x2900, 0x2980, 0x2A00, 0x2A80, 0x2B00, 0x2B80,  // idx 15-8
        0x2C00, 0x2C80, 0x2D00, 0x2D80, 0x2E00, 0x2E80, 0x2F00, 0x2F80); // idx 7-0
    __m512i const lut1_i16x32 = _mm512_set_epi16(                        // indices 32-63
        0x3000, 0x3080, 0x3100, 0x3180, 0x3200, 0x3280, 0x3300, 0x3380,  // idx 63-56
        0x3400, 0x3480, 0x3500, 0x3580, 0x3600, 0x3680, 0x3700, 0x3780,  // idx 55-48
        0x3800, 0x3880, 0x3900, 0x3980, 0x3A00, 0x3A80, 0x3B00, 0x3B80,  // idx 47-40
        0x3C00, 0x3C80, 0x3D00, 0x3D80, 0x3E00, 0x3E80, 0x3F00, 0x3F80); // idx 39-32
    __m512i const lut2_i16x32 = _mm512_set_epi16(                        // indices 64-95
        0x4000, 0x4080, 0x4100, 0x4180, 0x4200, 0x4280, 0x4300, 0x4380,  // idx 95-88
        0x4400, 0x4480, 0x4500, 0x4580, 0x4600, 0x4680, 0x4700, 0x4780,  // idx 87-80
        0x4800, 0x4880, 0x4900, 0x4980, 0x4A00, 0x4A80, 0x4B00, 0x4B80,  // idx 79-72
        0x4C00, 0x4C80, 0x4D00, 0x4D80, 0x4E00, 0x4E80, 0x4F00, 0x4F80); // idx 71-64
    __m512i const lut3_i16x32 = _mm512_set_epi16(                        // indices 96-127
        0x5000, 0x5080, 0x5100, 0x5180, 0x5200, 0x5280, 0x5300, 0x5380,  // idx 127-120
        0x5400, 0x5480, 0x5500, 0x5580, 0x5600, 0x5680, 0x5700, 0x5780,  // idx 119-112
        0x5800, 0x5880, 0x5900, 0x5980, 0x5A00, 0x5A80, 0x5B00, 0x5B80,  // idx 111-104
        0x5C00, 0x5C80, 0x5D00, 0x5D80, 0x5E00, 0x5E80, 0x5F00, 0x7E00); // idx 103-96
