...
#pragma GCC target("avx2", "avx512f", "avx512vl", "bmi2", "avx512bw")
#pragma clang attribute push(__attribute__((target("avx2,avx512f,avx512vl,bmi2,avx512bw"))), apply_to = function)
...
NK_INTERNAL __m512i nk_e4m3x32_to_bf16x32_ice_(__m256i e4m3x32) {
    ...
    __m512i const lut3_i16x32 = _mm512_set_epi16(                       // indices 96-127, idx 127 is NaN
        ...
        0x4380, 0x4390, 0x43A0, 0x43B0, 0x43C0, 0x43D0, 0x43E0, 0x7FC0);
