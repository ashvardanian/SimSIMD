...
NK_PUBLIC void nk_sqeuclidean_f16_svehalf(nk_f16_t const *a_enum, nk_f16_t const *b_enum, nk_size_t n,
    ...
    do {
        ...
        d2_f32x = svmla_f32_x(pred_even_f32x, d2_f32x, diff_even_f32x, diff_even_f32x);
        ...
        d2_f32x = svmla_f32_x(pred_odd_f32x, d2_f32x, diff_odd_f32x, diff_odd_f32x);
...
NK_PUBLIC void nk_angular_f16_svehalf(nk_f16_t const *a_enum, nk_f16_t const *b_enum, nk_size_t n, nk_f32_t *result) {
    ...
    do {
        ...
        svfloat32_t a_even_f32x = svcvt_f32_f16_x(pred_even_f32x, a_f16x);
        svfloat32_t b_even_f32x = svcvt_f32_f16_x(pred_even_f32x, b_f16x);
        ab_f32x = svmla_f32_x(pred_even_f32x, ab_f32x, a_even_f32x, b_even_f32x);
        a2_f32x = svmla_f32_x(pred_even_f32x, a2_f32x, a_even_f32x, a_even_f32x);
        b2_f32x = svmla_f32_x(pred_even_f32x, b2_f32x, b_even_f32x, b_even_f32x);

        // Odd-indexed f16 elements (1, 3, 5, ...) via svext shift-by-1
        svbool_t pred_odd_f32x = svwhilelt_b32_u64(0, remaining / 2);
        svfloat32_t a_odd_f32x = svcvt_f32_f16_x(pred_odd_f32x, svext_f16(a_f16x, a_f16x, 1));
        svfloat32_t b_odd_f32x = svcvt_f32_f16_x(pred_odd_f32x, svext_f16(b_f16x, b_f16x, 1));
        ab_f32x = svmla_f32_x(pred_odd_f32x, ab_f32x, a_odd_f32x, b_odd_f32x);
        a2_f32x = svmla_f32_x(pred_odd_f32x, a2_f32x, a_odd_f32x, a_odd_f32x);
        b2_f32x = svmla_f32_x(pred_odd_f32x, b2_f32x, b_odd_f32x, b_odd_f32x);
