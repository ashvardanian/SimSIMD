...
NK_PUBLIC void nk_sqeuclidean_f16_rvvhalf(nk_f16_t const *a_scalars, nk_f16_t const *b_scalars, nk_size_t count_scalars,
    ...
    for (nk_size_t vl; count_scalars > 0; count_scalars -= vl, a_scalars += vl, b_scalars += vl) {
        ...
        vfloat32m2_t sq_f32m2 = __riscv_vfwmul_vv_f32m2(diff_f16m1, diff_f16m1, vl);
        // Reduction sum
        sum_f32m1 = __riscv_vfredusum_vs_f32m2_f32m1(sq_f32m2, sum_f32m1, vl);
    }
...
NK_PUBLIC void nk_angular_f16_rvvhalf(nk_f16_t const *a_scalars, nk_f16_t const *b_scalars, nk_size_t count_scalars,
    ...
    for (nk_size_t vl; count_scalars > 0; count_scalars -= vl, a_scalars += vl, b_scalars += vl) {
        ...
        // a_sq += a × a
        vfloat32m2_t aa_f32m2 = __riscv_vfwmul_vv_f32m2(a_f16m1, a_f16m1, vl);
        a_sq_f32m1 = __riscv_vfredusum_vs_f32m2_f32m1(aa_f32m2, a_sq_f32m1, vl);

        // b_sq += b × b
        vfloat32m2_t bb_f32m2 = __riscv_vfwmul_vv_f32m2(b_f16m1, b_f16m1, vl);
