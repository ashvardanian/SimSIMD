...
NK_PUBLIC void nk_sqeuclidean_bf16_svebfdot(nk_bf16_t const *a_enum, nk_bf16_t const *b_enum, nk_size_t n,
    ...
    do {
        ...
        d2_low_f32x = svmla_f32_x(predicate_low_f32x, d2_low_f32x, a_minus_b_low_f32x, a_minus_b_low_f32x);
        d2_high_f32x = svmla_f32_x(predicate_high_f32x, d2_high_f32x, a_minus_b_high_f32x, a_minus_b_high_f32x);
        i += svcnth();
    } while (i < n);
