...
NK_INTERNAL nk_f64_t nk_reduce_add_f64x2_v128relaxed_(v128_t vec) {
...
NK_INTERNAL nk_i32_t nk_reduce_add_i32x4_v128relaxed_(v128_t vec) {
...
NK_INTERNAL nk_u32_t nk_reduce_add_u32x4_v128relaxed_(v128_t vec) {
    v128_t hi = wasm_i32x4_shuffle(vec, vec, 2, 3, 0, 0);
    v128_t sum1 = wasm_i32x4_add(vec, hi);
    v128_t hi2 = wasm_i32x4_shuffle(sum1, sum1, 1, 0, 0, 0);
    v128_t sum2 = wasm_i32x4_add(sum1, hi2);
