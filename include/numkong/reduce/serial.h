...
NK_PUBLIC void nk_reduce_min_f16_serial(                           //
    ...
    unsigned char const *ptr = (unsigned char const *)data;
    nk_f32_t best_value;
    nk_f16_to_f32_serial((nk_f16_t const *)ptr, &best_value);
    nk_size_t best_index = 0;
    ptr += stride_bytes;
    for (nk_size_t i = 1; i < count; ++i, ptr += stride_bytes) {
        nk_f32_t val;
...
NK_PUBLIC void nk_reduce_min_bf16_serial(                           //
    ...
    unsigned char const *ptr = (unsigned char const *)data;
    nk_f32_t best_value;
    nk_bf16_to_f32_serial((nk_bf16_t const *)ptr, &best_value);
    nk_size_t best_index = 0;
    ptr += stride_bytes;
    for (nk_size_t i = 1; i < count; ++i, ptr += stride_bytes) {
        nk_f32_t val;
...
NK_PUBLIC void nk_reduce_min_e4m3_serial(                           //
    ...
    unsigned char const *ptr = (unsigned char const *)data;
    nk_f32_t best_value;
    nk_e4m3_to_f32_serial((nk_e4m3_t const *)ptr, &best_value);
    nk_size_t best_index = 0;
    ptr += stride_bytes;
    for (nk_size_t i = 1; i < count; ++i, ptr += stride_bytes) {
        nk_f32_t val;
...
NK_PUBLIC void nk_reduce_min_e5m2_serial(                           //
    ...
    unsigned char const *ptr = (unsigned char const *)data;
    nk_f32_t best_value;
    nk_e5m2_to_f32_serial((nk_e5m2_t const *)ptr, &best_value);
    nk_size_t best_index = 0;
    ptr += stride_bytes;
    for (nk_size_t i = 1; i < count; ++i, ptr += stride_bytes) {
        nk_f32_t val;
