...
#include "numkong/dot/neon.h"      // `nk_dot_bf16_neon`
#include "numkong/dot/neonhalf.h"  // `nk_dot_f16_neonhalf`
...
NK_PUBLIC nk_f32_t nk_maxsim_packed_bf16_neonsdot( //
    ...
    for (nk_size_t chunk_start = 0; chunk_start < query_count; chunk_start += 256) {
        ...
        for (nk_size_t query_index = 0; query_index < chunk_size; query_index++) {
            ...
            nk_f32_t dot_result;
            nk_dot_bf16_neon((nk_bf16_t const *)(regions.query_originals +
...
NK_PUBLIC nk_f32_t nk_maxsim_packed_f32_neonsdot( //
    void const *query_packed, void const *document_packed, nk_size_t query_count, nk_size_t document_count,
    nk_size_t depth) {
...
NK_PUBLIC nk_f32_t nk_maxsim_packed_f16_neonsdot( //
    void const *query_packed, void const *document_packed, nk_size_t query_count, nk_size_t document_count,
    nk_size_t depth) {
