...
NK_PUBLIC void nk_dot_bf16_neon(nk_bf16_t const *a_scalars, nk_bf16_t const *b_scalars, nk_size_t count_scalars,
    ...
    for (; idx + 8 <= count_scalars; idx += 8) {
        ...
        float32x4_t a_lo_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_low_u16(a_u16x8), 16));
        float32x4_t a_hi_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_high_u16(a_u16x8), 16));
        float32x4_t b_lo_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_low_u16(b_u16x8), 16));
        float32x4_t b_hi_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_high_u16(b_u16x8), 16));
        sum_f32x4 = vfmaq_f32(sum_f32x4, a_lo_f32x4, b_lo_f32x4);
        sum_f32x4 = vfmaq_f32(sum_f32x4, a_hi_f32x4, b_hi_f32x4);
    }
    if (idx < count_scalars) {
        ...
        float32x4_t a_lo_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_low_u16(a_vec.u16x8), 16));
        float32x4_t a_hi_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_high_u16(a_vec.u16x8), 16));
        float32x4_t b_lo_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_low_u16(b_vec.u16x8), 16));
        float32x4_t b_hi_f32x4 = vreinterpretq_f32_u32(vshll_n_u16(vget_high_u16(b_vec.u16x8), 16));
        sum_f32x4 = vfmaq_f32(sum_f32x4, a_lo_f32x4, b_lo_f32x4);
        sum_f32x4 = vfmaq_f32(sum_f32x4, a_hi_f32x4, b_hi_f32x4);
    }
...
NK_PUBLIC void nk_dot_e4m3_neon(nk_e4m3_t const *a_scalars, nk_e4m3_t const *b_scalars, nk_size_t count_scalars,
    ...
    for (; idx + 8 <= count_scalars; idx += 8) {
        ...
        float32x4_t a_lo_f32x4 = vcvt_f32_f16(vget_low_f16(a_f16x8));
        float32x4_t a_hi_f32x4 = vcvt_f32_f16(vget_high_f16(a_f16x8));
        float32x4_t b_lo_f32x4 = vcvt_f32_f16(vget_low_f16(b_f16x8));
        float32x4_t b_hi_f32x4 = vcvt_f32_f16(vget_high_f16(b_f16x8));
        sum_f32x4 = vfmaq_f32(sum_f32x4, a_lo_f32x4, b_lo_f32x4);
        sum_f32x4 = vfmaq_f32(sum_f32x4, a_hi_f32x4, b_hi_f32x4);
    }
    if (idx < count_scalars) {
