...
// Compiling for 32-bit Arm: NK_TARGET_ARM32_
#if !defined(NK_TARGET_ARM32_)
#if defined(__arm__) || defined(_M_ARM)
#define NK_TARGET_ARM32_ 1
#else
#define NK_TARGET_ARM32_ 0
#endif // defined(__arm__) || defined(_M_ARM)
#endif // !defined(NK_TARGET_ARM32_)
...
#if !defined(NK_TARGET_NEON) || (NK_TARGET_NEON && !(NK_TARGET_ARM64_ || NK_TARGET_ARM32_))
...
#if !defined(NK_TARGET_NEONSDOT) || (NK_TARGET_NEONSDOT && !(NK_TARGET_ARM64_ || NK_TARGET_ARM32_))
...
#if !defined(NK_TARGET_NEONHALF) || (NK_TARGET_NEONHALF && !(NK_TARGET_ARM64_ || NK_TARGET_ARM32_))
...
#if !defined(NK_TARGET_NEONFHM) || (NK_TARGET_NEONFHM && !(NK_TARGET_ARM64_ || NK_TARGET_ARM32_))
