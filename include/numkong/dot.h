...
/** @copydoc nk_dot_u8 */
NK_PUBLIC void nk_dot_u8_neon(nk_u8_t const *a, nk_u8_t const *b, nk_size_t n, nk_u32_t *result);
...
NK_INTERNAL void nk_dot_i8x16_finalize_neon(nk_dot_i8x16_state_neon_t const *state_a,
                                            ...
                                            nk_dot_i8x16_state_neon_t const *state_d, nk_i32_t *results);
...
/** @copydoc nk_dot_bf16c */
NK_PUBLIC void nk_dot_bf16c_neon(nk_bf16c_t const *a, nk_bf16c_t const *b, nk_size_t n, nk_f32c_t *result);
/** @copydoc nk_vdot_bf16c */
NK_PUBLIC void nk_vdot_bf16c_neon(nk_bf16c_t const *a, nk_bf16c_t const *b, nk_size_t n, nk_f32c_t *result);
...
typedef struct nk_dot_f32x8_state_haswell_t nk_dot_f32x8_state_haswell_t;
/** @copydoc nk_dot_f32x8_state_haswell_t */
...
/** @copydoc nk_dot_f32x8_state_haswell_t */
NK_INTERNAL void nk_dot_f32x8_finalize_haswell(nk_dot_f32x8_state_haswell_t const *state_a,
                                               nk_dot_f32x8_state_haswell_t const *state_b,
                                               nk_dot_f32x8_state_haswell_t const *state_c,
                                               nk_dot_f32x8_state_haswell_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_f16x16_state_haswell_t nk_dot_f16x16_state_haswell_t;
/** @copydoc nk_dot_f16x16_state_haswell_t */
...
/** @copydoc nk_dot_f16x16_state_haswell_t */
NK_INTERNAL void nk_dot_f16x16_finalize_haswell(nk_dot_f16x16_state_haswell_t const *state_a,
                                                nk_dot_f16x16_state_haswell_t const *state_b,
                                                nk_dot_f16x16_state_haswell_t const *state_c,
                                                nk_dot_f16x16_state_haswell_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_bf16x16_state_haswell_t nk_dot_bf16x16_state_haswell_t;
/** @copydoc nk_dot_bf16x16_state_haswell_t */
...
/** @copydoc nk_dot_bf16x16_state_haswell_t */
NK_INTERNAL void nk_dot_bf16x16_finalize_haswell(nk_dot_bf16x16_state_haswell_t const *state_a,
                                                 nk_dot_bf16x16_state_haswell_t const *state_b,
                                                 nk_dot_bf16x16_state_haswell_t const *state_c,
                                                 nk_dot_bf16x16_state_haswell_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e4m3x32_state_haswell_t nk_dot_e4m3x32_state_haswell_t;
/** @copydoc nk_dot_e4m3x32_state_haswell_t */
NK_INTERNAL void nk_dot_e4m3x32_init_haswell(nk_dot_e4m3x32_state_haswell_t *state);
/** @copydoc nk_dot_e4m3x32_state_haswell_t */
NK_INTERNAL void nk_dot_e4m3x32_update_haswell(nk_dot_e4m3x32_state_haswell_t *state, nk_b256_vec_t a, nk_b256_vec_t b);
/** @copydoc nk_dot_e4m3x32_state_haswell_t */
NK_INTERNAL void nk_dot_e4m3x32_finalize_haswell(nk_dot_e4m3x32_state_haswell_t const *state_a,
                                                 nk_dot_e4m3x32_state_haswell_t const *state_b,
                                                 nk_dot_e4m3x32_state_haswell_t const *state_c,
                                                 nk_dot_e4m3x32_state_haswell_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e5m2x32_state_haswell_t nk_dot_e5m2x32_state_haswell_t;
/** @copydoc nk_dot_e5m2x32_state_haswell_t */
NK_INTERNAL void nk_dot_e5m2x32_init_haswell(nk_dot_e5m2x32_state_haswell_t *state);
/** @copydoc nk_dot_e5m2x32_state_haswell_t */
NK_INTERNAL void nk_dot_e5m2x32_update_haswell(nk_dot_e5m2x32_state_haswell_t *state, nk_b256_vec_t a, nk_b256_vec_t b);
/** @copydoc nk_dot_e5m2x32_state_haswell_t */
NK_INTERNAL void nk_dot_e5m2x32_finalize_haswell(nk_dot_e5m2x32_state_haswell_t const *state_a,
                                                 nk_dot_e5m2x32_state_haswell_t const *state_b,
                                                 nk_dot_e5m2x32_state_haswell_t const *state_c,
                                                 nk_dot_e5m2x32_state_haswell_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_i8x32_state_haswell_t nk_dot_i8x32_state_haswell_t;
/** @copydoc nk_dot_i8x32_state_haswell_t */
...
/** @copydoc nk_dot_i8x32_state_haswell_t */
NK_INTERNAL void nk_dot_i8x32_finalize_haswell(nk_dot_i8x32_state_haswell_t const *state_a,
                                               nk_dot_i8x32_state_haswell_t const *state_b,
                                               nk_dot_i8x32_state_haswell_t const *state_c,
                                               nk_dot_i8x32_state_haswell_t const *state_d, nk_i32_t *results);

typedef struct nk_dot_u8x32_state_haswell_t nk_dot_u8x32_state_haswell_t;
/** @copydoc nk_dot_u8x32_state_haswell_t */
...
/** @copydoc nk_dot_u8x32_state_haswell_t */
NK_INTERNAL void nk_dot_u8x32_finalize_haswell(nk_dot_u8x32_state_haswell_t const *state_a,
                                               nk_dot_u8x32_state_haswell_t const *state_b,
                                               nk_dot_u8x32_state_haswell_t const *state_c,
                                               nk_dot_u8x32_state_haswell_t const *state_d, nk_u32_t *results);
...
NK_INTERNAL void nk_dot_f64x8_finalize_skylake(nk_dot_f64x8_state_skylake_t const *state_a,
                                               ...
                                               nk_dot_f64x8_state_skylake_t const *state_d, nk_f64_t *results);

typedef struct nk_dot_f32x16_state_skylake_t nk_dot_f32x16_state_skylake_t;
/** @copydoc nk_dot_f32x16_state_skylake_t */
...
/** @copydoc nk_dot_f32x16_state_skylake_t */
NK_INTERNAL void nk_dot_f32x16_finalize_skylake(nk_dot_f32x16_state_skylake_t const *state_a,
                                                nk_dot_f32x16_state_skylake_t const *state_b,
                                                nk_dot_f32x16_state_skylake_t const *state_c,
                                                nk_dot_f32x16_state_skylake_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e4m3x64_state_skylake_t nk_dot_e4m3x64_state_skylake_t;
/** @copydoc nk_dot_e4m3x64_state_skylake_t */
NK_INTERNAL void nk_dot_e4m3x64_init_skylake(nk_dot_e4m3x64_state_skylake_t *state);
/** @copydoc nk_dot_e4m3x64_state_skylake_t */
NK_INTERNAL void nk_dot_e4m3x64_update_skylake(nk_dot_e4m3x64_state_skylake_t *state, nk_b512_vec_t a, nk_b512_vec_t b);
/** @copydoc nk_dot_e4m3x64_state_skylake_t */
NK_INTERNAL void nk_dot_e4m3x64_finalize_skylake(nk_dot_e4m3x64_state_skylake_t const *state_a,
                                                 nk_dot_e4m3x64_state_skylake_t const *state_b,
                                                 nk_dot_e4m3x64_state_skylake_t const *state_c,
                                                 nk_dot_e4m3x64_state_skylake_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e5m2x64_state_skylake_t nk_dot_e5m2x64_state_skylake_t;
/** @copydoc nk_dot_e5m2x64_state_skylake_t */
NK_INTERNAL void nk_dot_e5m2x64_init_skylake(nk_dot_e5m2x64_state_skylake_t *state);
/** @copydoc nk_dot_e5m2x64_state_skylake_t */
NK_INTERNAL void nk_dot_e5m2x64_update_skylake(nk_dot_e5m2x64_state_skylake_t *state, nk_b512_vec_t a, nk_b512_vec_t b);
/** @copydoc nk_dot_e5m2x64_state_skylake_t */
NK_INTERNAL void nk_dot_e5m2x64_finalize_skylake(nk_dot_e5m2x64_state_skylake_t const *state_a,
                                                 nk_dot_e5m2x64_state_skylake_t const *state_b,
                                                 nk_dot_e5m2x64_state_skylake_t const *state_c,
                                                 nk_dot_e5m2x64_state_skylake_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_i8x64_finalize_ice(nk_dot_i8x64_state_ice_t const *state_a,
                                           ...
                                           nk_dot_i8x64_state_ice_t const *state_d, nk_i32_t *results);
...
NK_INTERNAL void nk_dot_bf16x32_finalize_genoa(nk_dot_bf16x32_state_genoa_t const *state_a,
                                               ...
                                               nk_dot_bf16x32_state_genoa_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e4m3x64_state_genoa_t nk_dot_e4m3x64_state_genoa_t;
/** @copydoc nk_dot_e4m3x64_state_genoa_t */
...
/** @copydoc nk_dot_e4m3x64_state_genoa_t */
NK_INTERNAL void nk_dot_e4m3x64_finalize_genoa(nk_dot_e4m3x64_state_genoa_t const *state_a,
                                               nk_dot_e4m3x64_state_genoa_t const *state_b,
                                               nk_dot_e4m3x64_state_genoa_t const *state_c,
                                               nk_dot_e4m3x64_state_genoa_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e5m2x64_state_genoa_t nk_dot_e5m2x64_state_genoa_t;
/** @copydoc nk_dot_e5m2x64_state_genoa_t */
...
/** @copydoc nk_dot_e5m2x64_state_genoa_t */
NK_INTERNAL void nk_dot_e5m2x64_finalize_genoa(nk_dot_e5m2x64_state_genoa_t const *state_a,
                                               nk_dot_e5m2x64_state_genoa_t const *state_b,
                                               nk_dot_e5m2x64_state_genoa_t const *state_c,
                                               nk_dot_e5m2x64_state_genoa_t const *state_d, nk_f32_t *results);
#endif // NK_TARGET_GENOA

#if NK_TARGET_SAPPHIRE
/** @copydoc nk_dot_f16 */
NK_PUBLIC void nk_dot_f16_sapphire(nk_f16_t const *a, nk_f16_t const *b, nk_size_t n, nk_f32_t *result);
/** @copydoc nk_dot_f16c */
NK_PUBLIC void nk_dot_f16c_sapphire(nk_f16c_t const *a, nk_f16c_t const *b, nk_size_t n, nk_f32c_t *result);
/** @copydoc nk_vdot_f16c */
NK_PUBLIC void nk_vdot_f16c_sapphire(nk_f16c_t const *a, nk_f16c_t const *b, nk_size_t n, nk_f32c_t *result);

/** @copydoc nk_dot_e4m3 */
NK_PUBLIC void nk_dot_e4m3_sapphire(nk_e4m3_t const *a, nk_e4m3_t const *b, nk_size_t n, nk_f32_t *result);
/** @copydoc nk_dot_e5m2 */
NK_PUBLIC void nk_dot_e5m2_sapphire(nk_e5m2_t const *a, nk_e5m2_t const *b, nk_size_t n, nk_f32_t *result);
/** @copydoc nk_dot_e5m2 */
NK_PUBLIC void nk_dot_e5m2_sapphire_lut(nk_e5m2_t const *a, nk_e5m2_t const *b, nk_size_t n, nk_f32_t *result);

typedef struct nk_dot_f16x32_state_sapphire_t nk_dot_f16x32_state_sapphire_t;
/** @copydoc nk_dot_f16x32_state_sapphire_t */
NK_INTERNAL void nk_dot_f16x32_init_sapphire(nk_dot_f16x32_state_sapphire_t *state);
/** @copydoc nk_dot_f16x32_state_sapphire_t */
NK_INTERNAL void nk_dot_f16x32_update_sapphire(nk_dot_f16x32_state_sapphire_t *state, nk_b512_vec_t a, nk_b512_vec_t b);
/** @copydoc nk_dot_f16x32_state_sapphire_t */
NK_INTERNAL void nk_dot_f16x32_finalize_sapphire(nk_dot_f16x32_state_sapphire_t const *state_a,
                                                 nk_dot_f16x32_state_sapphire_t const *state_b,
                                                 nk_dot_f16x32_state_sapphire_t const *state_c,
                                                 nk_dot_f16x32_state_sapphire_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e4m3x64_state_sapphire_t nk_dot_e4m3x64_state_sapphire_t;
/** @copydoc nk_dot_e4m3x64_state_sapphire_t */
...
NK_INTERNAL void nk_dot_e4m3x64_update_sapphire(nk_dot_e4m3x64_state_sapphire_t *state, nk_b512_vec_t a,
                                                nk_b512_vec_t b);
/** @copydoc nk_dot_e4m3x64_state_sapphire_t */
NK_INTERNAL void nk_dot_e4m3x64_finalize_sapphire(nk_dot_e4m3x64_state_sapphire_t const *state_a,
                                                  nk_dot_e4m3x64_state_sapphire_t const *state_b,
                                                  nk_dot_e4m3x64_state_sapphire_t const *state_c,
                                                  nk_dot_e4m3x64_state_sapphire_t const *state_d, nk_f32_t *results);

typedef struct nk_dot_e5m2x64_state_sapphire_t nk_dot_e5m2x64_state_sapphire_t;
/** @copydoc nk_dot_e5m2x64_state_sapphire_t */
...
NK_INTERNAL void nk_dot_e5m2x64_update_sapphire(nk_dot_e5m2x64_state_sapphire_t *state, nk_b512_vec_t a,
                                                nk_b512_vec_t b);
/** @copydoc nk_dot_e5m2x64_state_sapphire_t */
NK_INTERNAL void nk_dot_e5m2x64_finalize_sapphire(nk_dot_e5m2x64_state_sapphire_t const *state_a,
                                                  nk_dot_e5m2x64_state_sapphire_t const *state_b,
                                                  nk_dot_e5m2x64_state_sapphire_t const *state_c,
                                                  nk_dot_e5m2x64_state_sapphire_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_f64x2_finalize_serial(nk_dot_f64x2_state_serial_t const *state_a,
                                              ...
                                              nk_dot_f64x2_state_serial_t const *state_d, nk_f64_t *results);
...
NK_INTERNAL void nk_dot_f32x4_finalize_serial(nk_dot_f32x4_state_serial_t const *state_a,
                                              ...
                                              nk_dot_f32x4_state_serial_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_f16x8_finalize_serial(nk_dot_f16x8_state_serial_t const *state_a,
                                              ...
                                              nk_dot_f16x8_state_serial_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_bf16x8_finalize_serial(nk_dot_bf16x8_state_serial_t const *state_a,
                                               ...
                                               nk_dot_bf16x8_state_serial_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_i8x16_finalize_serial(nk_dot_i8x16_state_serial_t const *state_a,
                                              ...
                                              nk_dot_i8x16_state_serial_t const *state_d, nk_i32_t *results);
...
NK_INTERNAL void nk_dot_u8x16_finalize_serial(nk_dot_u8x16_state_serial_t const *state_a,
                                              ...
                                              nk_dot_u8x16_state_serial_t const *state_d, nk_u32_t *results);
...
NK_INTERNAL void nk_dot_e4m3x16_finalize_serial(nk_dot_e4m3x16_state_serial_t const *state_a,
                                                ...
                                                nk_dot_e4m3x16_state_serial_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_e5m2x16_finalize_serial(nk_dot_e5m2x16_state_serial_t const *state_a,
                                                ...
                                                nk_dot_e5m2x16_state_serial_t const *state_d, nk_f32_t *results);
...
NK_INTERNAL void nk_dot_f16x8_update_serial(nk_dot_f16x8_state_serial_t *state, nk_b128_vec_t a, nk_b128_vec_t b) {
    ...
    for (nk_size_t i = 0; i < 8; i += 4) {
        ...
        nk_f16_to_f32(a.f16s + i + 0, &a0);
        nk_f16_to_f32(a.f16s + i + 1, &a1);
        nk_f16_to_f32(a.f16s + i + 2, &a2);
        nk_f16_to_f32(a.f16s + i + 3, &a3);
        nk_f16_to_f32(b.f16s + i + 0, &b0);
        nk_f16_to_f32(b.f16s + i + 1, &b1);
        nk_f16_to_f32(b.f16s + i + 2, &b2);
        nk_f16_to_f32(b.f16s + i + 3, &b3);
        sum0 += a0 * b0;
        sum1 += a1 * b1;
        sum2 += a2 * b2;
        sum3 += a3 * b3;
...
NK_INTERNAL void nk_dot_bf16x8_update_serial(nk_dot_bf16x8_state_serial_t *state, nk_b128_vec_t a, nk_b128_vec_t b) {
    ...
    for (nk_size_t i = 0; i < 8; i += 4) {
        nk_f32_t a0, a1, a2, a3, b0, b1, b2, b3;
        nk_bf16_to_f32(a.bf16s + i + 0, &a0);
        nk_bf16_to_f32(a.bf16s + i + 1, &a1);
        nk_bf16_to_f32(a.bf16s + i + 2, &a2);
        nk_bf16_to_f32(a.bf16s + i + 3, &a3);
        nk_bf16_to_f32(b.bf16s + i + 0, &b0);
        nk_bf16_to_f32(b.bf16s + i + 1, &b1);
        nk_bf16_to_f32(b.bf16s + i + 2, &b2);
        nk_bf16_to_f32(b.bf16s + i + 3, &b3);
        sum0 += a0 * b0;
        sum1 += a1 * b1;
        sum2 += a2 * b2;
        sum3 += a3 * b3;
...
NK_INTERNAL void nk_dot_i8x16_update_serial(nk_dot_i8x16_state_serial_t *state, nk_b128_vec_t a, nk_b128_vec_t b) {
    ...
    sum0 += (nk_i16_t)a.i8s[0] * (nk_i16_t)b.i8s[0];
    sum1 += (nk_i16_t)a.i8s[1] * (nk_i16_t)b.i8s[1];
    sum0 += (nk_i16_t)a.i8s[2] * (nk_i16_t)b.i8s[2];
    sum1 += (nk_i16_t)a.i8s[3] * (nk_i16_t)b.i8s[3];
    sum0 += (nk_i16_t)a.i8s[4] * (nk_i16_t)b.i8s[4];
    sum1 += (nk_i16_t)a.i8s[5] * (nk_i16_t)b.i8s[5];
    sum0 += (nk_i16_t)a.i8s[6] * (nk_i16_t)b.i8s[6];
    sum1 += (nk_i16_t)a.i8s[7] * (nk_i16_t)b.i8s[7];
    sum0 += (nk_i16_t)a.i8s[8] * (nk_i16_t)b.i8s[8];
    sum1 += (nk_i16_t)a.i8s[9] * (nk_i16_t)b.i8s[9];
    sum0 += (nk_i16_t)a.i8s[10] * (nk_i16_t)b.i8s[10];
    sum1 += (nk_i16_t)a.i8s[11] * (nk_i16_t)b.i8s[11];
    sum0 += (nk_i16_t)a.i8s[12] * (nk_i16_t)b.i8s[12];
    sum1 += (nk_i16_t)a.i8s[13] * (nk_i16_t)b.i8s[13];
    sum0 += (nk_i16_t)a.i8s[14] * (nk_i16_t)b.i8s[14];
    sum1 += (nk_i16_t)a.i8s[15] * (nk_i16_t)b.i8s[15];
...
NK_INTERNAL void nk_dot_u8x16_update_serial(nk_dot_u8x16_state_serial_t *state, nk_b128_vec_t a, nk_b128_vec_t b) {
    ...
    sum0 += (nk_u16_t)a.u8s[0] * (nk_u16_t)b.u8s[0];
    sum1 += (nk_u16_t)a.u8s[1] * (nk_u16_t)b.u8s[1];
    sum0 += (nk_u16_t)a.u8s[2] * (nk_u16_t)b.u8s[2];
    sum1 += (nk_u16_t)a.u8s[3] * (nk_u16_t)b.u8s[3];
    sum0 += (nk_u16_t)a.u8s[4] * (nk_u16_t)b.u8s[4];
    sum1 += (nk_u16_t)a.u8s[5] * (nk_u16_t)b.u8s[5];
    sum0 += (nk_u16_t)a.u8s[6] * (nk_u16_t)b.u8s[6];
    sum1 += (nk_u16_t)a.u8s[7] * (nk_u16_t)b.u8s[7];
    sum0 += (nk_u16_t)a.u8s[8] * (nk_u16_t)b.u8s[8];
    sum1 += (nk_u16_t)a.u8s[9] * (nk_u16_t)b.u8s[9];
    sum0 += (nk_u16_t)a.u8s[10] * (nk_u16_t)b.u8s[10];
    sum1 += (nk_u16_t)a.u8s[11] * (nk_u16_t)b.u8s[11];
    sum0 += (nk_u16_t)a.u8s[12] * (nk_u16_t)b.u8s[12];
    sum1 += (nk_u16_t)a.u8s[13] * (nk_u16_t)b.u8s[13];
    sum0 += (nk_u16_t)a.u8s[14] * (nk_u16_t)b.u8s[14];
    sum1 += (nk_u16_t)a.u8s[15] * (nk_u16_t)b.u8s[15];
...
NK_INTERNAL void nk_dot_e4m3x16_update_serial(nk_dot_e4m3x16_state_serial_t *state, nk_b128_vec_t a, nk_b128_vec_t b) {
    ...
    for (nk_size_t i = 0; i != 16; i += 4) {
        nk_e4m3_to_f32(a.e4m3s + i, &ai0);
        nk_e4m3_to_f32(b.e4m3s + i, &bi0);
        nk_e4m3_to_f32(a.e4m3s + i + 1, &ai1);
        nk_e4m3_to_f32(b.e4m3s + i + 1, &bi1);
        nk_e4m3_to_f32(a.e4m3s + i + 2, &ai2);
        nk_e4m3_to_f32(b.e4m3s + i + 2, &bi2);
        nk_e4m3_to_f32(a.e4m3s + i + 3, &ai3);
        nk_e4m3_to_f32(b.e4m3s + i + 3, &bi3);
        sum0 += ai0 * bi0;
        sum1 += ai1 * bi1;
        sum2 += ai2 * bi2;
        sum3 += ai3 * bi3;
...
NK_INTERNAL void nk_dot_e5m2x16_update_serial(nk_dot_e5m2x16_state_serial_t *state, nk_b128_vec_t a, nk_b128_vec_t b) {
    ...
    nk_f32_t bi0, bi1, bi2, bi3;
    for (nk_size_t i = 0; i != 16; i += 4) {
        nk_e5m2_to_f32(a.e5m2s + i, &ai0);
        nk_e5m2_to_f32(b.e5m2s + i, &bi0);
        nk_e5m2_to_f32(a.e5m2s + i + 1, &ai1);
        nk_e5m2_to_f32(b.e5m2s + i + 1, &bi1);
        nk_e5m2_to_f32(a.e5m2s + i + 2, &ai2);
        nk_e5m2_to_f32(b.e5m2s + i + 2, &bi2);
        nk_e5m2_to_f32(a.e5m2s + i + 3, &ai3);
        nk_e5m2_to_f32(b.e5m2s + i + 3, &bi3);
        sum0 += ai0 * bi0;
        sum1 += ai1 * bi1;
        sum2 += ai2 * bi2;
        sum3 += ai3 * bi3;
...
#if NK_TARGET_SAPPHIRE
    nk_dot_e4m3_sapphire(a, b, n, result);
...
#if NK_TARGET_SAPPHIRE
    nk_dot_e5m2_sapphire(a, b, n, result);
#elif NK_TARGET_GENOA
