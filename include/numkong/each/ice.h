 ...
 *  @file include/numkong/each/ice.h
 ...
 */
#ifndef NK_EACH_ICE_H
#define NK_EACH_ICE_H
...
nk_each_sum_i8_ice_cycle:
    ...
    result += 64;
    if (n) goto nk_each_sum_i8_ice_cycle;
}
...
nk_each_sum_u8_ice_cycle:
    ...
    result += 64;
    if (n) goto nk_each_sum_u8_ice_cycle;
}
...
nk_each_sum_i16_ice_cycle:
    ...
    result += 32;
    if (n) goto nk_each_sum_i16_ice_cycle;
}
...
nk_each_sum_u16_ice_cycle:
    ...
    result += 32;
    if (n) goto nk_each_sum_u16_ice_cycle;
}
...
nk_each_sum_i32_ice_cycle:
    ...
    result += 16;
    if (n) goto nk_each_sum_i32_ice_cycle;
}
...
nk_each_sum_u32_ice_cycle:
    ...
    result += 16;
    if (n) goto nk_each_sum_u32_ice_cycle;
}
...
nk_each_sum_i64_ice_cycle:
    ...
    result += 8;
    if (n) goto nk_each_sum_i64_ice_cycle;
}
...
nk_each_sum_u64_ice_cycle:
    ...
    result += 8;
    if (n) goto nk_each_sum_u64_ice_cycle;
}
