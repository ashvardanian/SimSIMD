...
NK_MAKE_SUM(serial, u16, i64, nk_assign_from_to_, nk_i64_to_u16_)     // nk_sum_u16_serial
NK_MAKE_SUM(serial, i32, i64, nk_assign_from_to_, nk_i64_to_i32_)     // nk_sum_i32_serial
NK_MAKE_SUM(serial, u32, i64, nk_assign_from_to_, nk_i64_to_u32_)     // nk_sum_u32_serial
...
NK_MAKE_SUM(accurate, f16, f64, nk_f16_to_f64_, nk_f64_to_f16_)         // nk_sum_f16_accurate
NK_MAKE_SUM(accurate, bf16, f64, nk_bf16_to_f64_, nk_f64_to_bf16_)      // nk_sum_bf16_accurate
...
NK_MAKE_SCALE(serial, u16, f32, nk_assign_from_to_, nk_f32_to_u16_)     // nk_scale_u16_serial
NK_MAKE_SCALE(serial, i32, f64, nk_assign_from_to_, nk_f64_to_i32_)     // nk_scale_i32_serial
NK_MAKE_SCALE(serial, u32, f64, nk_assign_from_to_, nk_f64_to_u32_)     // nk_scale_u32_serial
NK_MAKE_SCALE(serial, i64, f64, nk_assign_from_to_, nk_f64_to_i64_)     // nk_scale_i64_serial
NK_MAKE_SCALE(serial, u64, f64, nk_assign_from_to_, nk_f64_to_u64_)     // nk_scale_u64_serial

NK_MAKE_SCALE(accurate, f32, f64, nk_assign_from_to_, nk_assign_from_to_) // nk_scale_f32_accurate
NK_MAKE_SCALE(accurate, f16, f64, nk_f16_to_f64_, nk_f64_to_f16_)         // nk_scale_f16_accurate
NK_MAKE_SCALE(accurate, bf16, f64, nk_bf16_to_f64_, nk_f64_to_bf16_)      // nk_scale_bf16_accurate
NK_MAKE_SCALE(accurate, i8, f64, nk_assign_from_to_, nk_f64_to_i8_)       // nk_scale_i8_accurate
NK_MAKE_SCALE(accurate, u8, f64, nk_assign_from_to_, nk_f64_to_u8_)       // nk_scale_u8_accurate
...
NK_MAKE_WSUM(serial, u16, f32, nk_assign_from_to_, nk_f32_to_u16_)     // nk_wsum_u16_serial
NK_MAKE_WSUM(serial, i32, f64, nk_assign_from_to_, nk_f64_to_i32_)     // nk_wsum_i32_serial
NK_MAKE_WSUM(serial, u32, f64, nk_assign_from_to_, nk_f64_to_u32_)     // nk_wsum_u32_serial
NK_MAKE_WSUM(serial, i64, f64, nk_assign_from_to_, nk_f64_to_i64_)     // nk_wsum_i64_serial
NK_MAKE_WSUM(serial, u64, f64, nk_assign_from_to_, nk_f64_to_u64_)     // nk_wsum_u64_serial

NK_MAKE_WSUM(accurate, f32, f64, nk_assign_from_to_, nk_assign_from_to_) // nk_wsum_f32_accurate
NK_MAKE_WSUM(accurate, f16, f64, nk_f16_to_f64_, nk_f64_to_f16_)         // nk_wsum_f16_accurate
NK_MAKE_WSUM(accurate, bf16, f64, nk_bf16_to_f64_, nk_f64_to_bf16_)      // nk_wsum_bf16_accurate
NK_MAKE_WSUM(accurate, i8, f64, nk_assign_from_to_, nk_f64_to_i8_)       // nk_wsum_i8_accurate
NK_MAKE_WSUM(accurate, u8, f64, nk_assign_from_to_, nk_f64_to_u8_)       // nk_wsum_u8_accurate
...
NK_MAKE_FMA(serial, u16, f32, nk_assign_from_to_, nk_f32_to_u16_)     // nk_fma_u16_serial
NK_MAKE_FMA(serial, i32, f64, nk_assign_from_to_, nk_f64_to_i32_)     // nk_fma_i32_serial
NK_MAKE_FMA(serial, u32, f64, nk_assign_from_to_, nk_f64_to_u32_)     // nk_fma_u32_serial
NK_MAKE_FMA(serial, i64, f64, nk_assign_from_to_, nk_f64_to_i64_)     // nk_fma_i64_serial
NK_MAKE_FMA(serial, u64, f64, nk_assign_from_to_, nk_f64_to_u64_)     // nk_fma_u64_serial

NK_MAKE_FMA(accurate, f32, f64, nk_assign_from_to_, nk_assign_from_to_) // nk_fma_f32_accurate
NK_MAKE_FMA(accurate, f16, f64, nk_f16_to_f64_, nk_f64_to_f16_)         // nk_fma_f16_accurate
