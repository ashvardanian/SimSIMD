...
void bench_cross_serial() {
    ...
    run_dots_packed<u1_k>("dots_packed_u1_serial", nk_dots_packed_size_u1_serial, nk_dots_pack_u1_serial,
    ...
    run_dots_symmetric<u1_k>("dots_symmetric_u1_serial", nk_dots_symmetric_u1_serial);
