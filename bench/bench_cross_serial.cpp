...
void bench_cross_serial() {
    ...
    run_hammings_packed<u1_k>("hammings_u1_serial", nk_hammings_packed_size_u1_serial, nk_hammings_pack_u1_serial,
                              run_hammings_packed nk_hammings_packed_u1_serial);
    run_hammings_symmetric<u1_k>("hammings_symmetric_u1_serial", nk_hammings_symmetric_u1_serial);
    run_jaccards_packed<u1_k>("jaccards_u1_serial", nk_jaccards_packed_size_u1_serial, nk_jaccards_pack_u1_serial,
