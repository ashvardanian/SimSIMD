...
void bench_cross_x86() {
    ...
    run_hammings_packed<u1_k>("hammings_u1_haswell", nk_hammings_packed_size_u1_haswell, nk_hammings_pack_u1_haswell,
                              nk_hammings_packed_u1_haswell);
    run_hammings_symmetric<u1_k>("hammings_symmetric_u1_haswell", nk_hammings_symmetric_u1_haswell);
    run_jaccards_packed<u1_k>("jaccards_u1_haswell", nk_jaccards_packed_size_u1_haswell, nk_jaccards_pack_u1_haswell,
    ...
    run_hammings_packed<u1_k>("hammings_u1_icelake", nk_hammings_packed_size_u1_icelake, nk_hammings_pack_u1_icelake,
                              nk_hammings_packed_u1_icelake);
    run_hammings_symmetric<u1_k>("hammings_symmetric_u1_icelake", nk_hammings_symmetric_u1_icelake);
    run_jaccards_packed<u1_k>("jaccards_u1_icelake", nk_jaccards_packed_size_u1_icelake, nk_jaccards_pack_u1_icelake,
