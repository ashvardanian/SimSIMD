...
napi_value api_l2eu(napi_env env, napi_callback_info info) {
...
napi_value Init(napi_env env, napi_value exports) {
    ...
    napi_property_descriptor l2euclidean_descriptor = {"euclidean", 0, api_l2eu, 0, 0, 0, napi_default, 0};
    ...
    napi_property_descriptor properties[] = {
        dot_descriptor,     inner_descriptor,   sqeuclidean_descriptor, l2euclidean_descriptor, cosine_descriptor,
