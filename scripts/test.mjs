...
import * as mathkong from "../javascript/dist/esm/mathkong.js";
...
test("Distance from itself", () => {
  ...
  assertAlmostEqual(mathkong.sqeuclidean(f32s, f32s), 0.0, 0.01);
  assertAlmostEqual(mathkong.angular(f32s, f32s), 0.0, 0.01);
  ...
  assertAlmostEqual(mathkong.sqeuclidean(f64s, f64s), 0.0, 0.01);
  assertAlmostEqual(mathkong.angular(f64s, f64s), 0.0, 0.01);
  ...
  assertAlmostEqual(mathkong.inner(f32sNormalized, f32sNormalized), 1.0, 0.01);
  ...
  assertAlmostEqual(
    mathkong.kullbackleibler(f32sHistogram, f32sHistogram),
    0.0,
    0.01
  );
  assertAlmostEqual(
    mathkong.jensenshannon(f32sHistogram, f32sHistogram),
    0.0,
    0.01
  );
  assertAlmostEqual(
  ...
  assertAlmostEqual(mathkong.hamming(u8s, u8s), 0.0, 0.01);
  assertAlmostEqual(mathkong.jaccard(u8s, u8s), 0.0, 0.01);
});
...
test("Squared Euclidean Distance", () => {
  ...
  const f64sResult = mathkong.sqeuclidean(f64sOne, f64sTwo);
  ...
  const f32sResult = mathkong.sqeuclidean(f32sOne, f32sTwo);
  ...
  const u8sResult = mathkong.sqeuclidean(u8sOne, u8sTwo);
  ...
  const i8sResult = mathkong.sqeuclidean(i8sOne, i8sTwo);
...
test("Euclidean Distance", () => {
  const f64sOne = new Float64Array([1.0, 2.0, 3.0]);
  const f64sTwo = new Float64Array([4.0, 5.0, 6.0]);
  const f64sResult = mathkong.euclidean(f64sOne, f64sTwo);
  ...
  const f32sOne = new Float32Array([1.0, 2.0, 3.0]);
  const f32sTwo = new Float32Array([4.0, 5.0, 6.0]);
  const f32sResult = mathkong.euclidean(f32sOne, f32sTwo);
  ...
  const u8sOne = new Uint8Array([1, 2, 3]);
  const u8sTwo = new Uint8Array([4, 5, 6]);
  const u8sResult = mathkong.euclidean(u8sOne, u8sTwo);
  ...
  const i8sOne = new Int8Array([1, 2, 3]);
  const i8sTwo = new Int8Array([4, 5, 6]);
  const i8sResult = mathkong.euclidean(i8sOne, i8sTwo);
...
test("Inner Product", () => {
  const f64sOne = new Float64Array([1.0, 2.0, 3.0]);
  const f64sTwo = new Float64Array([4.0, 5.0, 6.0]);
  const f64sResult = mathkong.inner(f64sOne, f64sTwo);
  ...
  const f32sOne = new Float32Array([1.0, 2.0, 3.0]);
  const f32sTwo = new Float32Array([4.0, 5.0, 6.0]);
  const f32sResult = mathkong.inner(f32sOne, f32sTwo);
  ...
  const u8sOne = new Uint8Array([1, 2, 3]);
  const u8sTwo = new Uint8Array([4, 5, 6]);
  const u8sResult = mathkong.inner(u8sOne, u8sTwo);
  ...
  const i8sOne = new Int8Array([1, 2, 3]);
  const i8sTwo = new Int8Array([4, 5, 6]);
  const i8sResult = mathkong.inner(i8sOne, i8sTwo);
...
test("Angular Distance", () => {
  const f64sOne = new Float64Array([1.0, 2.0, 3.0]);
  const f64sTwo = new Float64Array([4.0, 5.0, 6.0]);
  const f64sResult = mathkong.angular(f64sOne, f64sTwo);
  ...
  const f32sOne = new Float32Array([1.0, 2.0, 3.0]);
  const f32sTwo = new Float32Array([4.0, 5.0, 6.0]);
  const f32sResult = mathkong.angular(f32sOne, f32sTwo);
  ...
  const u8sOne = new Uint8Array([1, 2, 3]);
  const u8sTwo = new Uint8Array([4, 5, 6]);
  const u8sResult = mathkong.angular(u8sOne, u8sTwo);
  ...
  const i8sOne = new Int8Array([1, 2, 3]);
  const i8sTwo = new Int8Array([4, 5, 6]);
  const i8sResult = mathkong.angular(i8sOne, i8sTwo);
...
test("Kullback-Leibler", () => {
  ...
  const f64sResult = mathkong.kullbackleibler(f64sOne, f64sTwo);
  ...
  const f32sResult = mathkong.kullbackleibler(f32sOne, f32sTwo);
...
test("Jensen-Shannon", () => {
  const f64sOne = new Float64Array([1.0 / 6, 2.0 / 6, 3.0 / 6]);
  const f64sTwo = new Float64Array([4.0 / 17, 5.0 / 17, 6.0 / 17]);
  const f64sResult = mathkong.jensenshannon(f64sOne, f64sTwo);
  ...
  const f32sOne = new Float32Array([1.0 / 6, 2.0 / 6, 3.0 / 6]);
  const f32sTwo = new Float32Array([4.0 / 17, 5.0 / 17, 6.0 / 17]);
  const f32sResult = mathkong.jensenshannon(f32sOne, f32sTwo);
