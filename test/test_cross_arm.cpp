...
void test_cross_arm() {
    ...
    // Hammings tests
    run_if_matches("hammings_u1_neon", test_hammings_packed<u1x8_t>, nk_hammings_packed_size_u1_neon,
                   nk_hammings_pack_u1_neon, nk_hammings_packed_u1_neon);
    run_if_matches("hammings_symmetric_u1_neon", test_hammings_symmetric<u1x8_t>, nk_hammings_symmetric_u1_neon);

    // Jaccards tests
    run_if_matches("jaccards_u1_neon", test_jaccards_packed<u1x8_t>, nk_jaccards_packed_size_u1_neon,
                   nk_jaccards_pack_u1_neon, nk_jaccards_packed_u1_neon);
