...
void test_cross_rvv() {
#if NK_TARGET_RVV
    run_if_matches("dots_f64_rvv", test_dots_packed<f64_t>, nk_dots_packed_size_f64_rvv, nk_dots_pack_f64_rvv,
                   nk_dots_packed_f64_rvv);
    run_if_matches("dots_f32_rvv", test_dots_packed<f32_t>, nk_dots_packed_size_f32_rvv, nk_dots_pack_f32_rvv,
                   nk_dots_packed_f32_rvv);
    run_if_matches("dots_f16_rvv", test_dots_packed<f16_t>, nk_dots_packed_size_f16_rvv, nk_dots_pack_f16_rvv,
                   nk_dots_packed_f16_rvv);
    run_if_matches("dots_bf16_rvv", test_dots_packed<bf16_t>, nk_dots_packed_size_bf16_rvv, nk_dots_pack_bf16_rvv,
                   nk_dots_packed_bf16_rvv);
    run_if_matches("dots_e4m3_rvv", test_dots_packed<e4m3_t>, nk_dots_packed_size_e4m3_rvv, nk_dots_pack_e4m3_rvv,
                   nk_dots_packed_e4m3_rvv);
    run_if_matches("dots_e5m2_rvv", test_dots_packed<e5m2_t>, nk_dots_packed_size_e5m2_rvv, nk_dots_pack_e5m2_rvv,
                   nk_dots_packed_e5m2_rvv);
    run_if_matches("dots_e2m3_rvv", test_dots_packed<e2m3_t>, nk_dots_packed_size_e2m3_rvv, nk_dots_pack_e2m3_rvv,
                   nk_dots_packed_e2m3_rvv);
    run_if_matches("dots_e3m2_rvv", test_dots_packed<e3m2_t>, nk_dots_packed_size_e3m2_rvv, nk_dots_pack_e3m2_rvv,
                   nk_dots_packed_e3m2_rvv);
    run_if_matches("dots_i8_rvv", test_dots_packed<i8_t>, nk_dots_packed_size_i8_rvv, nk_dots_pack_i8_rvv,
                   nk_dots_packed_i8_rvv);
    run_if_matches("dots_u8_rvv", test_dots_packed<u8_t>, nk_dots_packed_size_u8_rvv, nk_dots_pack_u8_rvv,
    ...
    run_if_matches("angulars_f64_rvv", test_angulars_packed<f64_t>, nk_dots_packed_size_f64_rvv, nk_dots_pack_f64_rvv,
                   nk_angulars_packed_f64_rvv);
    run_if_matches("angulars_f32_rvv", test_angulars_packed<f32_t>, nk_dots_packed_size_f32_rvv, nk_dots_pack_f32_rvv,
                   nk_angulars_packed_f32_rvv);
    run_if_matches("angulars_f16_rvv", test_angulars_packed<f16_t>, nk_dots_packed_size_f16_rvv, nk_dots_pack_f16_rvv,
                   nk_angulars_packed_f16_rvv);
    run_if_matches("angulars_bf16_rvv", test_angulars_packed<bf16_t>, nk_dots_packed_size_bf16_rvv,
                   nk_dots_pack_bf16_rvv, nk_angulars_packed_bf16_rvv);
    run_if_matches("angulars_e4m3_rvv", test_angulars_packed<e4m3_t>, nk_dots_packed_size_e4m3_rvv,
                   nk_dots_pack_e4m3_rvv, nk_angulars_packed_e4m3_rvv);
    run_if_matches("angulars_e5m2_rvv", test_angulars_packed<e5m2_t>, nk_dots_packed_size_e5m2_rvv,
                   nk_dots_pack_e5m2_rvv, nk_angulars_packed_e5m2_rvv);
    run_if_matches("angulars_e2m3_rvv", test_angulars_packed<e2m3_t>, nk_dots_packed_size_e2m3_rvv,
                   nk_dots_pack_e2m3_rvv, nk_angulars_packed_e2m3_rvv);
    run_if_matches("angulars_e3m2_rvv", test_angulars_packed<e3m2_t>, nk_dots_packed_size_e3m2_rvv,
                   nk_dots_pack_e3m2_rvv, nk_angulars_packed_e3m2_rvv);
    run_if_matches("angulars_i8_rvv", test_angulars_packed<i8_t>, nk_dots_packed_size_i8_rvv, nk_dots_pack_i8_rvv,
                   nk_angulars_packed_i8_rvv);
    run_if_matches("angulars_u8_rvv", test_angulars_packed<u8_t>, nk_dots_packed_size_u8_rvv, nk_dots_pack_u8_rvv,
    ...
    run_if_matches("euclideans_f64_rvv", test_euclideans_packed<f64_t>, nk_dots_packed_size_f64_rvv,
                   nk_dots_pack_f64_rvv, nk_euclideans_packed_f64_rvv);
    run_if_matches("euclideans_f32_rvv", test_euclideans_packed<f32_t>, nk_dots_packed_size_f32_rvv,
                   nk_dots_pack_f32_rvv, nk_euclideans_packed_f32_rvv);
    run_if_matches("euclideans_f16_rvv", test_euclideans_packed<f16_t>, nk_dots_packed_size_f16_rvv,
                   nk_dots_pack_f16_rvv, nk_euclideans_packed_f16_rvv);
    run_if_matches("euclideans_bf16_rvv", test_euclideans_packed<bf16_t>, nk_dots_packed_size_bf16_rvv,
                   nk_dots_pack_bf16_rvv, nk_euclideans_packed_bf16_rvv);
    run_if_matches("euclideans_e4m3_rvv", test_euclideans_packed<e4m3_t>, nk_dots_packed_size_e4m3_rvv,
                   nk_dots_pack_e4m3_rvv, nk_euclideans_packed_e4m3_rvv);
    run_if_matches("euclideans_e5m2_rvv", test_euclideans_packed<e5m2_t>, nk_dots_packed_size_e5m2_rvv,
                   nk_dots_pack_e5m2_rvv, nk_euclideans_packed_e5m2_rvv);
    run_if_matches("euclideans_e2m3_rvv", test_euclideans_packed<e2m3_t>, nk_dots_packed_size_e2m3_rvv,
                   nk_dots_pack_e2m3_rvv, nk_euclideans_packed_e2m3_rvv);
    run_if_matches("euclideans_e3m2_rvv", test_euclideans_packed<e3m2_t>, nk_dots_packed_size_e3m2_rvv,
                   nk_dots_pack_e3m2_rvv, nk_euclideans_packed_e3m2_rvv);
    run_if_matches("euclideans_i8_rvv", test_euclideans_packed<i8_t>, nk_dots_packed_size_i8_rvv, nk_dots_pack_i8_rvv,
                   nk_euclideans_packed_i8_rvv);
    run_if_matches("euclideans_u8_rvv", test_euclideans_packed<u8_t>, nk_dots_packed_size_u8_rvv, nk_dots_pack_u8_rvv,
