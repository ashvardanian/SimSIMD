...
void test_cross_amx() {
    ...
    check("dots_packed_f32_graniteamx", test_dots_packed<f32_t>, nk_dots_packed_size_f32_graniteamx,
          nk_dots_pack_f32_graniteamx, nk_dots_packed_f32_graniteamx);
    check("dots_symmetric_f16_graniteamx", test_dots_symmetric<f16_t>, nk_dots_symmetric_f16_graniteamx);
    check("dots_symmetric_f32_graniteamx", test_dots_symmetric<f32_t>, nk_dots_symmetric_f32_graniteamx);
    ...
    check("angulars_packed_f32_graniteamx", test_angulars_packed<f32_t>, nk_dots_packed_size_f32_graniteamx,
          nk_dots_pack_f32_graniteamx, nk_angulars_packed_f32_graniteamx);
    check("angulars_symmetric_f16_graniteamx", test_angulars_symmetric<f16_t>, nk_angulars_symmetric_f16_graniteamx);
    check("angulars_symmetric_f32_graniteamx", test_angulars_symmetric<f32_t>, nk_angulars_symmetric_f32_graniteamx);
    ...
    check("euclideans_packed_f32_graniteamx", test_euclideans_packed<f32_t>, nk_dots_packed_size_f32_graniteamx,
          nk_dots_pack_f32_graniteamx, nk_euclideans_packed_f32_graniteamx);
    check("euclideans_symmetric_f16_graniteamx", test_euclideans_symmetric<f16_t>,
          nk_euclideans_symmetric_f16_graniteamx);
    check("euclideans_symmetric_f32_graniteamx", test_euclideans_symmetric<f32_t>,
          nk_euclideans_symmetric_f32_graniteamx);
#endif
}
