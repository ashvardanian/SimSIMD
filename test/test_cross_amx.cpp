...
void test_cross_amx() {
    ...
    run_if_matches("dots_bf16_sapphireamx", test_dots_packed<bf16_t>, nk_dots_packed_size_bf16_sapphireamx,
                   nk_dots_pack_bf16_sapphireamx, nk_dots_packed_bf16_sapphireamx);
    run_if_matches("dots_i8_sapphireamx", test_dots_packed<i8_t>, nk_dots_packed_size_i8_sapphireamx,
                   nk_dots_pack_i8_sapphireamx, nk_dots_packed_i8_sapphireamx);
    run_if_matches("dots_e4m3_sapphireamx", test_dots_packed<e4m3_t>, nk_dots_packed_size_e4m3_sapphireamx,
                   nk_dots_pack_e4m3_sapphireamx, nk_dots_packed_e4m3_sapphireamx);
    run_if_matches("dots_e5m2_sapphireamx", test_dots_packed<e5m2_t>, nk_dots_packed_size_e5m2_sapphireamx,
