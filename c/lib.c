 ...
 */
#define MATHKONG_SQRT(x) mathkong_f32_sqrt(x)
#define MATHKONG_RSQRT(x) mathkong_f32_rsqrt(x)
#define MATHKONG_LOG(x) mathkong_f32_log(x)
 ...
 */
#if !defined(MATHKONG_TARGET_NEON) && (defined(__APPLE__) || defined(__linux__))
#define MATHKONG_TARGET_NEON 1
#endif
#if !defined(MATHKONG_TARGET_SVE) && (defined(__linux__))
#define MATHKONG_TARGET_SVE 1
#endif
#if !defined(MATHKONG_TARGET_SVE2) && (defined(__linux__))
#define MATHKONG_TARGET_SVE2 1
#endif
#if !defined(MATHKONG_TARGET_HASWELL) && (defined(_MSC_VER) || defined(__APPLE__) || defined(__linux__))
#define MATHKONG_TARGET_HASWELL 1
#endif
#if !defined(MATHKONG_TARGET_SKYLAKE) && (defined(_MSC_VER) || defined(__linux__))
#define MATHKONG_TARGET_SKYLAKE 1
#endif
#if !defined(MATHKONG_TARGET_ICE) && (defined(_MSC_VER) || defined(__linux__))
#define MATHKONG_TARGET_ICE 1
#endif
#if !defined(MATHKONG_TARGET_GENOA) && (defined(__linux__))
#define MATHKONG_TARGET_GENOA 1
#endif
#if !defined(MATHKONG_TARGET_SAPPHIRE) && (defined(__linux__))
#define MATHKONG_TARGET_SAPPHIRE 1
#endif
#if !defined(MATHKONG_TARGET_TURIN) && (defined(__linux__))
#define MATHKONG_TARGET_TURIN 1
#endif
#if !defined(MATHKONG_TARGET_SIERRA) && (defined(__linux__)) && 0 // TODO: Add target spec to GCC & Clang
...
#define MATHKONG_DECLARATION_DENSE(name, extension)                                                           \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(mathkong_##extension##_t const *a,                    \
...
#define MATHKONG_DECLARATION_SPARSE(name, extension)                                                                 \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(mathkong_##extension##_t const *a,                           \
...
#define MATHKONG_DECLARATION_CURVED(name, extension)                                                             \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(                                                         \
...
#define MATHKONG_DECLARATION_SCALE(name, extension)                                                            \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(mathkong_##extension##_t const *a, mathkong_size_t n,  \
...
#define MATHKONG_DECLARATION_SUM(name, extension)                                                              \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(mathkong_##extension##_t const *a,                     \
                                                        mathkong_##extension##_t const *b, mathkong_size_t n,  \
                                                        mathkong_##extension##_t *result) {                    \
...
#define MATHKONG_DECLARATION_FMA(name, extension)                                                                   \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(                                                            \
        mathkong_##extension##_t const *a, mathkong_##extension##_t const *b, mathkong_##extension##_t const *c,    \
...
#define MATHKONG_DECLARATION_WSUM(name, extension)                                                     \
    MATHKONG_DYNAMIC void mathkong_##name##_##extension(                                               \
...
// Dot products
MATHKONG_DECLARATION_DENSE(dot, i8)
MATHKONG_DECLARATION_DENSE(dot, u8)
MATHKONG_DECLARATION_DENSE(dot, f16)
MATHKONG_DECLARATION_DENSE(dot, bf16)
MATHKONG_DECLARATION_DENSE(dot, f32)
MATHKONG_DECLARATION_DENSE(dot, f64)
MATHKONG_DECLARATION_DENSE(dot, f16c)
MATHKONG_DECLARATION_DENSE(dot, bf16c)
MATHKONG_DECLARATION_DENSE(dot, f32c)
MATHKONG_DECLARATION_DENSE(dot, f64c)
MATHKONG_DECLARATION_DENSE(vdot, f16c)
MATHKONG_DECLARATION_DENSE(vdot, bf16c)
MATHKONG_DECLARATION_DENSE(vdot, f32c)
MATHKONG_DECLARATION_DENSE(vdot, f64c)

// Spatial distances
MATHKONG_DECLARATION_DENSE(angular, i8)
MATHKONG_DECLARATION_DENSE(angular, u8)
MATHKONG_DECLARATION_DENSE(angular, f16)
MATHKONG_DECLARATION_DENSE(angular, bf16)
MATHKONG_DECLARATION_DENSE(angular, f32)
MATHKONG_DECLARATION_DENSE(angular, f64)
MATHKONG_DECLARATION_DENSE(l2sq, i8)
MATHKONG_DECLARATION_DENSE(l2sq, u8)
MATHKONG_DECLARATION_DENSE(l2sq, f16)
MATHKONG_DECLARATION_DENSE(l2sq, bf16)
MATHKONG_DECLARATION_DENSE(l2sq, f32)
MATHKONG_DECLARATION_DENSE(l2sq, f64)
MATHKONG_DECLARATION_DENSE(l2, i8)
MATHKONG_DECLARATION_DENSE(l2, u8)
MATHKONG_DECLARATION_DENSE(l2, f16)
MATHKONG_DECLARATION_DENSE(l2, bf16)
MATHKONG_DECLARATION_DENSE(l2, f32)
MATHKONG_DECLARATION_DENSE(l2, f64)

// Binary distances
MATHKONG_DECLARATION_DENSE(hamming, b8)
MATHKONG_DECLARATION_DENSE(jaccard, b8)

// Probability distributions
MATHKONG_DECLARATION_DENSE(kl, f16)
MATHKONG_DECLARATION_DENSE(kl, bf16)
MATHKONG_DECLARATION_DENSE(kl, f32)
MATHKONG_DECLARATION_DENSE(kl, f64)
MATHKONG_DECLARATION_DENSE(js, f16)
MATHKONG_DECLARATION_DENSE(js, bf16)
MATHKONG_DECLARATION_DENSE(js, f32)
MATHKONG_DECLARATION_DENSE(js, f64)

// Sparse sets
MATHKONG_DECLARATION_SPARSE(intersect, u16, u16)
MATHKONG_DECLARATION_SPARSE(intersect, u32, u32)

// Curved spaces
MATHKONG_DECLARATION_CURVED(bilinear, f64)
MATHKONG_DECLARATION_CURVED(bilinear, f64c)
MATHKONG_DECLARATION_CURVED(mahalanobis, f64)
MATHKONG_DECLARATION_CURVED(bilinear, f32)
MATHKONG_DECLARATION_CURVED(bilinear, f32c)
MATHKONG_DECLARATION_CURVED(mahalanobis, f32)
MATHKONG_DECLARATION_CURVED(bilinear, f16)
MATHKONG_DECLARATION_CURVED(bilinear, f16c)
MATHKONG_DECLARATION_CURVED(mahalanobis, f16)
MATHKONG_DECLARATION_CURVED(bilinear, bf16)
MATHKONG_DECLARATION_CURVED(bilinear, bf16c)
MATHKONG_DECLARATION_CURVED(mahalanobis, bf16)

// Element-wise operations
MATHKONG_DECLARATION_SUM(sum, f64)
MATHKONG_DECLARATION_SUM(sum, f32)
MATHKONG_DECLARATION_SUM(sum, f16)
MATHKONG_DECLARATION_SUM(sum, bf16)
MATHKONG_DECLARATION_SUM(sum, i8)
MATHKONG_DECLARATION_SUM(sum, u8)
MATHKONG_DECLARATION_SUM(sum, i16)
MATHKONG_DECLARATION_SUM(sum, u16)
MATHKONG_DECLARATION_SUM(sum, i32)
MATHKONG_DECLARATION_SUM(sum, u32)
MATHKONG_DECLARATION_SUM(sum, i64)
MATHKONG_DECLARATION_SUM(sum, u64)
MATHKONG_DECLARATION_SCALE(scale, f64)
MATHKONG_DECLARATION_SCALE(scale, f32)
MATHKONG_DECLARATION_SCALE(scale, f16)
MATHKONG_DECLARATION_SCALE(scale, bf16)
MATHKONG_DECLARATION_SCALE(scale, i8)
MATHKONG_DECLARATION_SCALE(scale, u8)
MATHKONG_DECLARATION_SCALE(scale, i16)
MATHKONG_DECLARATION_SCALE(scale, u16)
MATHKONG_DECLARATION_SCALE(scale, i32)
MATHKONG_DECLARATION_SCALE(scale, u32)
MATHKONG_DECLARATION_SCALE(scale, i64)
MATHKONG_DECLARATION_SCALE(scale, u64)
MATHKONG_DECLARATION_WSUM(wsum, f64)
MATHKONG_DECLARATION_WSUM(wsum, f32)
MATHKONG_DECLARATION_WSUM(wsum, f16)
MATHKONG_DECLARATION_WSUM(wsum, bf16)
MATHKONG_DECLARATION_WSUM(wsum, i8)
MATHKONG_DECLARATION_WSUM(wsum, u8)
MATHKONG_DECLARATION_WSUM(wsum, i16)
MATHKONG_DECLARATION_WSUM(wsum, u16)
MATHKONG_DECLARATION_WSUM(wsum, i32)
MATHKONG_DECLARATION_WSUM(wsum, u32)
MATHKONG_DECLARATION_WSUM(wsum, i64)
MATHKONG_DECLARATION_WSUM(wsum, u64)
MATHKONG_DECLARATION_FMA(fma, f64)
MATHKONG_DECLARATION_FMA(fma, f32)
MATHKONG_DECLARATION_FMA(fma, f16)
MATHKONG_DECLARATION_FMA(fma, bf16)
MATHKONG_DECLARATION_FMA(fma, i8)
MATHKONG_DECLARATION_FMA(fma, u8)
MATHKONG_DECLARATION_FMA(fma, i16)
MATHKONG_DECLARATION_FMA(fma, u16)
MATHKONG_DECLARATION_FMA(fma, i32)
MATHKONG_DECLARATION_FMA(fma, u32)
MATHKONG_DECLARATION_FMA(fma, i64)
MATHKONG_DECLARATION_FMA(fma, u64)

MATHKONG_DYNAMIC int mathkong_uses_neon(void) { return (mathkong_capabilities() & mathkong_cap_neon_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_neon_f16(void) { return (mathkong_capabilities() & mathkong_cap_neon_f16_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_neon_bf16(void) { return (mathkong_capabilities() & mathkong_cap_neon_bf16_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_neon_i8(void) { return (mathkong_capabilities() & mathkong_cap_neon_i8_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_sve(void) { return (mathkong_capabilities() & mathkong_cap_sve_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_sve_f16(void) { return (mathkong_capabilities() & mathkong_cap_sve_f16_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_sve_bf16(void) { return (mathkong_capabilities() & mathkong_cap_sve_bf16_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_sve_i8(void) { return (mathkong_capabilities() & mathkong_cap_sve_i8_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_haswell(void) { return (mathkong_capabilities() & mathkong_cap_haswell_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_skylake(void) { return (mathkong_capabilities() & mathkong_cap_skylake_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_ice(void) { return (mathkong_capabilities() & mathkong_cap_ice_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_genoa(void) { return (mathkong_capabilities() & mathkong_cap_genoa_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_sapphire(void) { return (mathkong_capabilities() & mathkong_cap_sapphire_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_turin(void) { return (mathkong_capabilities() & mathkong_cap_turin_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_sierra(void) { return (mathkong_capabilities() & mathkong_cap_sierra_k) != 0; }
MATHKONG_DYNAMIC int mathkong_uses_dynamic_dispatch(void) { return 1; }
MATHKONG_DYNAMIC int mathkong_flush_denormals(void) { return _mathkong_flush_denormals(); }
