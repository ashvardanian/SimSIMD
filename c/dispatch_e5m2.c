...
void nk_dispatch_e5m2_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_rvv_k) switch (k) {
        ...
        case nk_kernel_reduce_add_k: *m = (m_t)&nk_reduce_add_e5m2_rvv, *c = nk_cap_rvv_k; return;
        case nk_kernel_reduce_min_k: *m = (m_t)&nk_reduce_min_e5m2_rvv, *c = nk_cap_rvv_k; return;
        case nk_kernel_reduce_max_k: *m = (m_t)&nk_reduce_max_e5m2_rvv, *c = nk_cap_rvv_k; return;
        default: break;
        }
#endif
    ...
    if (v & nk_cap_skylake_k) switch (k) {
        ...
        case nk_kernel_reduce_add_k: *m = (m_t)&nk_reduce_add_e5m2_skylake, *c = nk_cap_skylake_k; return;
        case nk_kernel_reduce_min_k: *m = (m_t)&nk_reduce_min_e5m2_skylake, *c = nk_cap_skylake_k; return;
        case nk_kernel_reduce_max_k: *m = (m_t)&nk_reduce_max_e5m2_skylake, *c = nk_cap_skylake_k; return;
        default: break;
        }
#endif
...
void nk_dispatch_e5m2_init_(nk_capability_t caps) {
    ...
    nk_dispatch_e5m2_find_(caps, nk_kernel_dots_k, (nk_kernel_punned_t *)&t->dots_packed_e5m2, &used);
