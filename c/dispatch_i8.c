...
void nk_dispatch_i8_init_(nk_capability_t caps) {
    ...
    nk_dispatch_i8_find_(caps, nk_kernel_reduce_add_k, (nk_kernel_punned_t *)&t->reduce_add_i8, &used);
    nk_dispatch_i8_find_(caps, nk_kernel_reduce_min_k, (nk_kernel_punned_t *)&t->reduce_min_i8, &used);
    nk_dispatch_i8_find_(caps, nk_kernel_reduce_max_k, (nk_kernel_punned_t *)&t->reduce_max_i8, &used);
    ...
    nk_dispatch_i8_find_(caps, nk_kernel_dots_k, (nk_kernel_punned_t *)&t->dots_packed_i8, &used);
