/**
 *  @brief Dtype dispatch file for i16 (signed 16-bit integer) kernels.
...
void nk_dispatch_i16_init_(nk_capability_t caps) {
    ...
    nk_dispatch_i16_find_(caps, nk_kernel_reduce_min_k, (nk_kernel_punned_t *)&t->reduce_min_i16, &used);
    nk_dispatch_i16_find_(caps, nk_kernel_reduce_max_k, (nk_kernel_punned_t *)&t->reduce_max_i16, &used);
}
