...
void nk_dispatch_e2m3_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_neonfhm_k) switch (k) {
        ...
        case nk_kernel_angulars_packed_k: *m = (m_t)&nk_angulars_packed_e2m3_neonfhm, *c = nk_cap_neonfhm_k; return;
        case nk_kernel_angulars_symmetric_k:
            *m = (m_t)&nk_angulars_symmetric_e2m3_neonfhm, *c = nk_cap_neonfhm_k;
            return;
        case nk_kernel_euclideans_packed_k: *m = (m_t)&nk_euclideans_packed_e2m3_neonfhm, *c = nk_cap_neonfhm_k; return;
        case nk_kernel_euclideans_symmetric_k:
            *m = (m_t)&nk_euclideans_symmetric_e2m3_neonfhm, *c = nk_cap_neonfhm_k;
            return;
        default: break;
        }
#endif
    ...
    if (v & nk_cap_genoa_k) switch (k) {
        ...
        case nk_kernel_angulars_packed_k: *m = (m_t)&nk_angulars_packed_e2m3_genoa, *c = nk_cap_genoa_k; return;
        case nk_kernel_angulars_symmetric_k: *m = (m_t)&nk_angulars_symmetric_e2m3_genoa, *c = nk_cap_genoa_k; return;
        case nk_kernel_euclideans_packed_k: *m = (m_t)&nk_euclideans_packed_e2m3_genoa, *c = nk_cap_genoa_k; return;
        case nk_kernel_euclideans_symmetric_k:
            *m = (m_t)&nk_euclideans_symmetric_e2m3_genoa, *c = nk_cap_genoa_k;
            return;
        default: break;
        }
#endif
